        ...
        <div class="content-response">
            <div class="product-view-top">
                ...
                <div class="product-view-info">
                    ...
                    <p class="item-brand">
                        <a href="javascript:void(0);" onclick="goBrandMain(this);" ctgryNo="BDMA21A09" ctgryOutptTpCd=""
                            outptLinkUrl="">
                            ${productVO.product_brand}</a>
                    </p>

                    <p class="item-tag">
                        <span class="code">${productVO.product_code}</span> <span class="tag" style="color: #C2935F">
                        </span>
                    </p>
                    ...
                    <div class="item-price">
                        ...
                        <input type="hidden" id="maxDcOnlneGrdCd" value="ALL" /> <input type="hidden"
                            id="publiQtyLmitCheck" value="PSB" /> <input type="hidden" id="maxPrice" value="18050" />
                        <input type="hidden" id="minPrice" value="18050" />
                    </div>
                    <div class="product-view-option">

                        <div class="option-bot">
                            <input type="hidden" class="minOrdQty" value="1" godno="GM0122040738612"> <input
                                type="hidden" class="maxOrdQty" value="9999" godno="GM0122040738612">
                            <div name="qtyDiv" class="row quantity gnrlOptQty" style="" godno="GM0122040738612"
                                selectoptionyn="Y">
                                <!-- 이거 어캐 좀 해봐야할듯 ,, -->
                            ...
                            <div name="qtyDiv" class="row quantity aditQtyDiv" style="display: none;" godno=""
                                selectoptionyn="N">
                                <strong class="tit"> [추가]<span class="name">상품명</span>옵션명
                                </strong> <span class="item-count">
                                    <button type="button" class="btn-minus" onclick="quantityCalc('minus');">
                                        <span>빼기</span>
                                    </button> <input type="number" name="quantity" class="input-num aditGodQty"
                                        value="2" onkeyup="changeQty(this);">
                                    <button type="button" class="btn-plus" onclick="quantityCalc('plus');">
                                        <span>더하기</span>
                                    </button>
                            ...
                            <div name="pkupDiv" class="dlv-sel" style="display: none;">
                                <label class="check-skin"> <input type="checkbox" onclick="checkDlvSect(this);"
                                        name="dlvSect_top" value="PKUP_DLV" godno="GM0122040738612"> <span>매장수령</span>
                                </label>
                            ...
                            <div class="btn-box">
                                ...
                                <button name="btnBuynow" type="button" class="btn-type2-xlg" onclick="go_direct_order()">
                                    <span> 
                                        바로구매
                                    </span>
                                </button>
                    ...
                    <div class="info-bot">
                        <ul class="list">
                            <li class="row"><span class="tit">배송비</span> <span> <input type="hidden"
                                        id="otskrDlvAditCost" value="Y" /> 30,000이상 구매시
                                    무료(도서산간추가 4000원)
            ...
            <div class="product-view-detail">
                <div class="product-detail-tab tab-wrap2 anchor-wrap">
                    ...
                    <!-- 상품 상세 정보 -->
                    <section id="tabContentReview" class="anchor-section product-detail-review"></section>
                    ...
                    <section id="tabContentReview" class="anchor-section product-detail-review">
                        ...
                        <div class="product-detail-review-list">
                            <div class="head">
                                <p class="txt">상품 구매 후 리뷰 작성시 H.Plus를 드립니다. (포토리뷰 1,000포인트, 텍스트리뷰 300포인트 증정)</p>
                                <div id="prdReviewFilter" class="opt">
                                    <div class="select">
                                        ...
                                        <div id="reviewSortFilter" class="sel-list">
                                            <ul>
                                                <li><label><input type="radio" name="rvList" value="new">
                                                        <span>최신순</span></label></li>
                                                <li><label><input type="radio" name="rvList" value="like">
                                                        <span>공감순</span></label></li>
                                            </ul>
                                        </div>
                                    </div>

                                    <div class="select">
                                        <button type="button" class="sel-btn" onclick="select.trigger();">${productVO.product_name}</button>
                                        <div class="sel-list">
                                            <ul>
                                                <li>
                                                    <label>
                                                        <input type="radio" name="optValCd1" value="2">
                                                        <span>S</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" name="optValCd1" value="3">
                                                        <span>M</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" name="optValCd1" value="4">
                                                        <span>L</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="radio" name="optValCd1" value="5">
                                                        <span>XL</span>
                                                    </label>
                                                </li>
                                            </ul>
                            ...
                            <div id="allReviewList" class="board-list board-review ui-fold" style="">
                                ...
                                <div id="layerReviewReport" class="layer-pop" tabindex="0" style="display: none;">
                                                ...
                                                <div class="layer-reviewReport">
                                                        ...
                                                        <ul class="radio-col-list">
                                                            <li>
                                                                <label class="radio-skin">
                                                                    <input type="radio" name="radioReviewReport"
                                                                        value="RP_PRD_IRRELEVANT">
                                                                    <span>상품 품질과 관련 없는 내용</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="radio-skin">
                                                            ...
                                                            <li>
                                                                <label class="radio-skin">
                                                                    <input type="radio" name="radioReviewReport"
                                                                        value="RP_COPYRIGHT">
                                                                    <span>저작권 불법 도용 (타인이 작성한 글, 사진 등)</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="radio-skin">
                                                                    <input type="radio" name="radioReviewReport"
                                                                        value="RP_SELLER_REVIEW">
                                                                    <span>상품 리뷰가 아닌 판매자 리뷰 내용</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="radio-skin">
                                                    ...
                                                    <div class="btn-box">
                                                        <button type="button" class="btn-type2-lg"
                                                            onclick="saveGodEvlReport(this)"><span>등록</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="photoReviewList" class="photo-list" style="display:none;"></div>
                        </div>
