			...
			<div class="products-info-image swiper-container">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="product_images/${productVO.product_code}_01.jpg" style="width:200px; height:200px;"/>
						<!-- 동기적으로 불러오기 -->
					</div>
					<div class="swiper-slide">
						<img src="product_images/${productVO.product_code}_02.jpg" style="width:200px; height:200px;"/>
						<!-- 동기적으로 불러오기 -->
					</div>
					<div class="swiper-slide">
						<img src="product_images/${productVO.product_code}_03.jpg" style="width:200px; height:200px;"/>
						<!-- 동기적으로 불러오기 -->
					</div>
					<div class="swiper-slide">
						<img src="product_images/${productVO.product_code}_04.jpg" style="width:200px; height:200px;"/>
						<!-- 동기적으로 불러오기 -->
					</div>
				</div>
			</div>
