					...
					<c:otherwise>
						<c:forEach var="review" items="${reviewList}">
							<div class="detail-qna-item">
								<span class="detail-qna-item-number">${review.od_id}</span> <a
									href="hfashionmallServlet?command=review_detail&product_code=${productVO.product_code}"
									target="_blank"> <span class="detail-qna-item-detail">${review.review_content}</span>
								</a> <span class="detail-qna-item-writerName">
									${review.mname}</span> <span class="detail-qna-item-createDate">
									<fmt:formatDate value="${review.review_register}" type="date" />
								</span>
							</div>
							<%-- 					<%
						reviewNo += 1;
