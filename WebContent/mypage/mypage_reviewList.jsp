...
<div id="container">
	<section class="content-wrap">
		...
		<div class="snb-content-wrap">
				...
				<dl class="period-btns-box">
					...
					<dd>
						<div class="period-btns">
							<label> <input type="radio" name="period" onclick="setDate('15d')"> <span>15일</span>
							</label> <label> <input type="radio" name="period" onclick="setDate('1m')" checked=""> <span>1개월</span>
							</label> <label> <input type="radio" name="period" onclick="setDate('3m')"> <span>3개월</span>
							</label> <label> <input type="radio" name="period" onclick="setDate('6m')"> <span>6개월</span>
							</label> <label> <input type="radio" name="period" onclick="setDate('12m')"> <span>12개월</span>
							</label>
						</div>
					</dd>
				</dl>
			...
			<div id="reviewFold" class="board-list board-review ui-fold">
				<!-- s: 200413 수정 || 리뷰 내용 텍스트 4줄 노출 후 클릭시 전체 노출 기능 추가, 첨부이미지 등록시 타입 추가 -->
								...
								<li>
									<div class="list-row fold-header">
										<div class="cell-title">
											<ul class="etc-info">
												<li><span class="point size-m"><span class="ico" style="width: 80%">별점 4점</span></span></li>
												<li>
													<button type="button" class="btn-like2" onclick="location.href='hfashionmallServlet?product_detail&product_code=${review.product_code}'" godevlturn="1" reviewgodno="115369702">
														<span class="like-count" likecnt="3"> </span>
													</button>
												</li>
												<li><span class="date">${review.review_register}</span></li>
											</ul>
