			...
			<tr>
				...
				<td id="id1" class="rateField view_hide" colspan="5">
					...
					<div class="r_content_wrapper">
						<form name="review" id="review" method="post" action="hfashionmallServlet?command=review_write&od_id=${orderVO.order_detail_id}">
							<textarea name="r_content" id="reviewText" style="resize: none;"></textarea>
							<input type="hidden" name="od_id" value="${orderVO.order_detail_id}"><!-- 여기서 서블렛으로 od_id값을 넘겨줌 -->
						</form>
					</div> <%-- 							<script>
