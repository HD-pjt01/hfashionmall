            ...
            <div class="layer-container">
                <div class="layer-content review-write">
                    <div class="write-inner">
                        ...
                        <section class="write-section">
                            <h3 class="sub-title">2 . 리뷰를 작성해 주세요 <span class="required">(필수)</span></h3>
                            ...
                            <input type="hidden" name="od_id" value="${orderVO.order_detail_id}"> <!-- 여기서 서블릿으로 전달  -->
...
<!--                                 <section class="write-section">
                    ...
                    <div class="btn-box">
                        <button type="submit"  form="review" class="btn-type2-lg"><span>등록</span></button>
                    </div>
