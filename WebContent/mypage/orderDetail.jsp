        ...
        <section class="content-wrap">
          ...
          <div class="snb-content-wrap">
            <script
              ...
              src="/resources/js/moment.js"
            ></script>
            <script
              type="text/javascript"
              src="/hfm_pc/resources/js/mypage/mypagecommon.js?timestamp=20220914145945"
            ></script>

            <input
              type="hidden"
              name="_csrf"
              value="c0a1f299-9cc0-47ee-a547-1ac477b0abb0"
            />
            ...
            <div id="includeOrderList" class="order-list-wrap">
                                  ...
                                  <div class="cell-pd-wrap">
                                      ...
                                      <div class="info-row">
                                        <div class="cell-pd">
                                          ...
                                          <div class="item-info">
                                            ...
                                            <div class="item-opt">
                                              <span> BLACK , F </span>
                                              <span>수량 : ${orderVO.product_count}</span>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="cell-status rowspan2">
                                      ...
                                      <div class="cell-inner">
                                        <div class="status">
                                         주문 완료<br />
                                          <span class="txt-cmt pcolor"
                                            >(입금기한 :
                                            <span class="num">9/16 </span>)</span
                                          >
                                        </div>
                                      </div>
                                    </div>
                                      ...
                                      <div class="cell-inner">
                                        <div class="btns">
                                          <button
                                            type="button"
                                            class="btn-type3-sm"
                                            onclick="jsUnitCancel('OD202209154384813', 'Y', 'N');"
                                          >
                                            <span>주문취소</span>
                                          </button>
                                        </div>
              ...
              <div class="paging">
                <span>
                  <strong title="현재 페이지" class="btn-page selected"
                    >1
                  </strong>
                </span>
              </div>
              ...
              <div class="process-txt-guide">
                <ol>
                  <li>
                    ...
                    <div class="txt">
                      주문이 정상적으로 접수 되었습니다.<br />
                      결제 방법을 현금 입금으로 선택하신 경우, 정해진 기간내에
                      입금이 완료 되어야<br />
                      결제완료 단계로 진행됩니다. 정해진 기간 경과시, 주문은
                      자동 취소 됩니다.
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="txt">
                      주문, 결제/입금이 최종 완료 되었습니다. 배송정보 수정 및
                      주문최소가 가능합니다.
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="txt">
                      상품의 재고를 확인하고, 상품의 택배 배송을 위해 준비하는
                      단계 입니다.<br />
                      (배송 준비중인 경우, 주문취소가 불가할 수 있습니다. 자세한
                      사항은<br />
                      고객센터(1800-5700) 또는 1:1게시판으로 문의 부탁
                      드립니다.)
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="txt">
                      택배사에 상품이 인계되어 고객님께 배송중입니다. 도서/산간
                      지역을 제외한 지역의경우,<br />
                  ...
                  <li>
                    ...
                    <div class="txt">
                      해당 물품을 고객님께서 수령하여 배송이 완료된 상태입니다.
                      포인트 적립 및 상품평<br />
                      작성이 가능합니다. 배송 완료 7일 이내에만 반품 및 교환
                      신청이 가능 합니다.
                    </div>
                  </li>
                </ol>
              ...
              <script type="text/javascript">
                ...
                function jsUnitCancel(ordNo, cnclPsblYn, lstClmPrgsYn) {
                  if (cnclPsblYn == "Y") {
                    jsLinkUrlPost("/secured/mypage/claimAccept", {
                      _csrf: "c0a1f299-9cc0-47ee-a547-1ac477b0abb0",
                      ordNo: ordNo,
                    });
                  } else if (lstClmPrgsYn == "Y") {
                    alert(
                      "추가 결제가 필요한 클레임이 존재합니다.\n 추가 결제완료 후 접수가 가능합니다."
                    );
                  } else {
                    alert(
                      "주문상품(패키지 또는 주문할인)과 일부 할인수단 및 결제수단을 사용한 주문은 전체취소만 가능합니다.\n 주문취소에 대한 자세한 문의는 1:1문의 혹은 고객센터로 문의해 주시기 바랍니다."
                    );
                  }
                  return false;
                }
                ...
                function jsRequestForReturn(ordNo, rtnPsblYn, lstClmPrgsYn) {
                  if (rtnPsblYn == "Y") {
                    jsLinkUrlPost("/secured/mypage/requestForReturn", {
                      _csrf: "c0a1f299-9cc0-47ee-a547-1ac477b0abb0",
                      ordNo: ordNo,
                    });
                  } else if (lstClmPrgsYn == "Y") {
                    ...
                    alert(
                      "주문상품(패키지 또는 주문할인)과 일부 할인수단 및 결제수단을 사용한 주문은 전체반품만 가능합니다.\n 반품에 대한 자세한 문의는 1:1문의 혹은 고객센터로 문의해 주시기 바랍니다."
                    );
                  }
                  return false;
                }
                ...
                function jsExchangeClaim(ordNo, exchPsblYn, lstClmPrgsYn) {
                  if (exchPsblYn == "Y") {
                    jsLinkUrlPost("/secured/mypage/exchangeClaim", {
                      _csrf: "c0a1f299-9cc0-47ee-a547-1ac477b0abb0",
                      ordNo: ordNo,
                    });
                  } else {
                    alert(
                      "고객센터를 통해서 교환 신청이 가능합니다.\n 교환에 대한 자세한 문의는 1:1문의 혹은 고객센터로 문의해 주시기 바랍니다."
                    );
                  }
                  return false;
                }
                ...
                /*상품리뷰 등록/수정  팝업 가져오기*/
                function getLayerPopupInsertGoodsReview(
                  ordNo,
                  ordGodTurn,
                  godNo,
                  godEvlTurn,
                ...
                function jsUpdateDeliveryStatus(
                  ordNo,
                  wayBilNo,
                  ordGodTurn,
                  godNo,
                  ...
                  isDoubleUpdate = true;
                  jsLinkUrlPost("/secured/mypage/deliveryStatus/update", {
                    _csrf: "c0a1f299-9cc0-47ee-a547-1ac477b0abb0",
                    ordNo: ordNo,
                    wayBilNo: wayBilNo,
            ...
            <script type="text/javascript">
              ...
              function goSearch(statCd, dayType) {
                ...
                var startDay = parseInt(
                  $("#dateStart").val().replace(/-/g, ""),
                  10
                );
                var endDay = parseInt(
                  $("#dateEnd").val().replace(/-/g, ""),
                  10
                );
                var toDay = parseInt(
                  moment().format("YYYY-MM-DD").replace(/-/g, ""),
                  10
                );
                if (startDay > endDay) {
              ...
              function checkDateTerm(fromDate, endDate) {
                var startDt = new Date(
                  Number(fromDate.substring(0, 4)),
                  Number(fromDate.substring(4, 6)) - 1,
