			...
			<nav id="gnb">
				...
				<div class="header-wrap">
					<div class="gnb-menu">
							...
							<div class="depth2">
								...
								<div class="depth2-inner active">
									<ul class="depth2-menu">
										...
										<li><a
											href="hfashionmallServlet?command=brand&case=Tommy Hilfiger"
										...
										<li><a
											href="hfashionmallServlet?command=brand&case=Calvin Klein"
										...
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="DEHGR">DECKE</a></li>
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="RAHGR">rouge＆lounge</a></li>
										<li><a href="javascript:void(0);"
										...
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="PWHGR">SJYP</a></li>
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="KPHGR">Kipling</a></li>
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="TMHGR">Taylormade</a></li>
										<li><a href="javascript:void(0);"
											onclick="goCategoryLink(this);" tp="OTLT_LIST" brndid="TBHGR">Timberland</a></li>
									</ul>
								</div>
						...
						<div class="gnb-category " id="">
							<a href="hfashionmallServlet?command=event"> <span>
									이벤트</span>
							</a>
						</div>
						<div class="gnb-category " id="">
