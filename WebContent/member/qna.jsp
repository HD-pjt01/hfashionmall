  ...
  <article>
    ...
    <form name="formm" method="post">
      ...
      <tr>  
        ...
        <td> <a href="hfashionmallServlet?command=qna_view&qna_sequence=${qnaVO.qna_sequence}"> ${qnaVO.qna_subject}</a> </td>      
      ...
      <input type="button"  value="1:1 질문하기"  class="submit"    onclick="location.href='hfashionmallServlet?command=qna_write_form'"> 
