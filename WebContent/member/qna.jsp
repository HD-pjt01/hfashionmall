	...
	<section class="content-wrap">
		...
		<nav id="snb" class="snb-cs">
			<ul>
				...
				<li id="voc" style="cursor: pointer;"
					onclick="layer.open('layerPrivacyAgree');">고객의 소리</li>
			</ul>
		</nav>
		<script>
		...
		<div class="cs-main">
			...
			<form id="faqForm" action="/public/cspage/faq" method="post"
				onsubmit="return chkFlag();">
				<input type="hidden" id="searchFaqSectCd" name="searchFaqSectCd"
					value="">
				<div class="cs-search-wrap">
					<div class="search-input-group">
						<div class="search-input">
							<input type="text" name="searchFaq" id="searchFaq" title="검색어"
								placeholder="검색어를 입력해 주세요." class="inp-search">
							<button type="button" id="searchBtn" onclick="return false;"
								class="btn-search">
								<span>검색</span>
							</button>
						</div>
						...
						<div class="frequency-keywords">
							...
							<ul class="keywords">
								<li><a href="javascript:void(0);"
									onclick="searchNoticeList('FAQ_GOD')">상품</a></li>
								<li><a href="javascript:void(0);"
									onclick="searchNoticeList('FAQ_ORD_PAY')">주문/결제</a></li>
								<li><a href="javascript:void(0);"
									onclick="searchNoticeList('FAQ_RTGOD_EXCHG')">교환/반품</a></li>
								<li><a href="javascript:void(0);"
									onclick="searchNoticeList('FAQ_MBR_BNEF')">회원/혜택</a></li>
								<li><a href="javascript:void(0);"
									onclick="searchFaqList('이벤트')">이벤트</a></li>
							</ul>
						</div>
					</div>
						...
						<dl>
							...
							<dd>
								...
								<div class="service-time">
									<p>
										평일 <span class="time">09 : 00 ~ 18 : 00</span>
									</p>
									<p>토, 일, 공휴일 휴무</p>
								</div>
							</dd>
			...
			<div class="cs-quick">
				<ul>
					<li class="quick1"><a href="javascript:void(0);"
						onclick="sessionCheck('/secured/mypage/listOrder','true')">주문배송조회</a></li>
					<li class="quick2"><a href="javascript:void(0);"
						onclick="sessionCheck('/secured/mypage/listClaimOrder','true')">취소/교환/반품
							신청</a></li>
					<li class="quick3"><a href="/public/member/searchMbrId">ID/PW
							찾기</a></li>
					<li class="quick4"><a href="/public/cspage/notice">이벤트 당첨
							확인</a></li>
					<li class="quick5"><a href="javascript:void(0);"
						onclick="sessionCheck('/secured/mypage/updateMember','true')">회원정보
							변경</a></li>
					<li class="quick6"><a href="/public/member/login?tabId=3">비회원
							주문조회</a></li>
				</ul>
			</div>
...
<p>&nbsp;</p>
<p>귀하께서는 한섬의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 고객의 소리 관리 담당자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것 입니다.</p>
						</pre>
					</div>
					...
					<div class="agree-wrap">
						...
						<div class="check-group">
							<label class="radio-skin"><input type="radio"
								name="privacyAgree" value="Y"><span>동의함</span></label> <label
								class="radio-skin"><input type="radio"
								name="privacyAgree" value="N" checked=""><span>동의안함</span></label>
						</div>
					</div>

					<ul class="txt-list">
						<li>개인정보수집을 원치 않으시면 E-mail(voc@hyundaihmall.com)을 통해서도 접수하실 수
							있습니다. 감사합니다.</li>
					</ul>
					<form id="moveVocPage" name="moveVocPage" method="post">
						<ul class="input-info-group">
							<li>
								<div class="input-box">
									<input type="text" title="고객명(필수)" placeholder="고객명(필수)"
										name="userNm" id="custNm" class="inp-reset">
									<div class="etc">
							...
							<li>
								<div class="input-box">
									<input type="text" title="연락처(필수)" placeholder="연락처(필수)"
										name="userPhone" id="custMpNo" class="inp-reset">
									<div class="etc">
										<button type="button" class="btn-clear">
											<span>지우기</span>
										</button>
