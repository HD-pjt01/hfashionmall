...
<section class="content-wrap">
	...
	<div id="container">
		...
		<input type="hidden" name="drmcMbrNo" id="drmcMbrNo" value="" /> <input
				...
				<div id="loginTab" class="login-tab tab-wrap2 ui-tab">
					<ul class="tabs tab-btn">
						<li class="on"><a href="javascript:;"
							onClick="hPointEnable()">H.Point 통합회원</a></li>
					...
					<div class="tab-cont">
						<div class="login-group simple">
							<div class="login-left">
								<form method="post" action="hfashionmallServlet?command=login" id="loginForm">
									<ul class="login-input">
										<li>
											<div class="input-box">
												<input type="text" title="H패션몰 아이디" placeholder="H패션몰 아이디" class="inp-reset" id="userIdMall" name="member_id" value="${id}" maxlength="20">
									...
									<div class="login-link">
										...
										<ul class="links">
											<li><a href="hfashionmallServlet?command=find_id_form">아이디 찾기</a></li>
											<li><a href="hfashionmallServlet?command=find_id_form">비밀번호 재설정</a></li>
										</ul>
									</div>
								</form>
								<div class="btn-box">
