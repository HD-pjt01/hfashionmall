(function (t) {
    ...
    I.widget = function (t, i, e) {
        ...
        if (I.isArray(e)) {
            e = I.extend.apply(null, [{}].concat(e))
        }
        I.expr[":"][l.toLowerCase()] = function (t) {
            return !!I.data(t, l)
        };
        I[r] = I[r] || {};
        s = I[r][t];
        n = I[r][t] = function (t, e) {
        ...
        a = new i;
        a.options = I.widget.extend({}, a.options);
        ...
        if (s) {
            I.each(s._childConstructors, function (t, e) {
                var i = e.prototype;
    ...
    I.widget.extend = function (t) {
        ...
        for (; i < s; i++) {
            for (n in e[i]) {
                a = e[i][n];
                if (e[i].hasOwnProperty(n) && a !== undefined) {
                    if (I.isPlainObject(a)) {
                        t[n] = I.isPlainObject(t[n]) ? I.widget.extend({}, t[n], a) : I.widget.extend({}, a)
                    } else {
                        t[n] = a
                    }
                }
            ...
            if (t) {
                if (!this.length && i === "instance") {
                    ...
                    this.each(function () {
                        ...
                        if (!e) {
                            return I.error("cannot call methods on " + a + " prior to initialization; " + "attempted to call method '" + i + "'")
                        }
                        if (!I.isFunction(e[i]) || i.charAt(0) === "_") {
                            return I.error("no such method '" + i + "' for " + a + " widget instance")
                        }
                        t = e[i].apply(e, s);
                        if (t !== e && t !== undefined) {
                ...
                if (s.length) {
                    i = I.widget.extend.apply(null, [i].concat(s))
                }
                this.each(function () {
                    var t = I.data(this, o);
                    if (t) {
    ...
    I.Widget.prototype = {
        ...
        _createWidget: function (t, e) {
            ...
            if (e !== this) {
                I.data(e, this.widgetFullName, this);
        ...
        destroy: function () {
            var i = this;
            this._destroy();
            I.each(this.classesElementLookup, function (t, e) {
                i._removeClass(e, t)
            });
        ...
        option: function (t, e) {
            ...
            if (typeof t === "string") {
                ...
                t = s.shift();
                if (s.length) {
                    n = i[t] = I.widget.extend({}, this.options[t]);
        ...
        _setOptionClasses: function (t) {
            ...
            for (e in t) {
                ...
                if (t[e] === this.options.classes[e] || !s || !s.length) {
                    continue
                }
                i = I(s.get());
        ...
        _classes: function (n) {
            ...
            function t(t, e) {
                ...
                for (s = 0; s < t.length; s++) {
                    i = o.classesElementLookup[t[s]] || I();
                    if (n.add) {
                        i = I(I.unique(i.get().concat(n.element.get())))
                    } else {
                        i = I(i.not(n.element).get())
                    }
                    o.classesElementLookup[t[s]] = i;
                    a.push(t[s]);
                    if (e && n.classes[t[s]]) {
                        a.push(n.classes[t[s]])
                    }
                }
            }
            this._on(n.element, {
        ...
        _untrackClassesElement: function (i) {
            ...
            I.each(s.classesElementLookup, function (t, e) {
                if (I.inArray(i.target, e) !== -1) {
                    s.classesElementLookup[t] = I(e.not(i.target).get())
                }
            })
        },
        ...
        _toggleClass: function (t, e, i, s) {
            ...
            a.element.toggleClass(this._classes(a), s);
            return this
        },
        _on: function (o, r, t) {
            var l;
            ...
            I.each(t, function (t, e) {
                function i() {
                    if (!o && (h.options.disabled === true || I(this).hasClass("ui-state-disabled"))) {
                        return
                    }
                    return (typeof e === "string" ? h[e] : e).apply(h, arguments)
                }
                if (typeof e !== "string") {
                    i.guid = e.guid = e.guid || i.guid || I.guid++
                }
                var s = t.match(/^([\w:-]*)\s*(.*)$/);
                var n = s[1] + h.eventNamespace;
                var a = s[2];
                if (a) {
                    l.on(n, a, i)
                } else {
        ...
        _trigger: function (t, e, i) {
            ...
            return !(I.isFunction(a) && a.apply(this.element[0], [e].concat(i)) === false || e.isDefaultPrevented())
        }
    };
    I.each({
        show: "fadeIn",
        ...
        I.Widget.prototype["_" + a] = function (e, t, i) {
            if (typeof t === "string") {
                t = {
                    effect: t
                }
            ...
            var s;
            var n = !t ? a : t === true || typeof t === "number" ? o : t.effect || o;
            t = t || {};
            if (typeof t === "number") {
                t = {
                    duration: t
            ...
            if (s && I.effects && I.effects.effect[n]) {
                e[a](t)
            } else if (n !== a && e[n]) {
    ...
    (function () {
        ...
        I.position = {
            ...
            getScrollInfo: function (t) {
                var e = t.isWindow || t.isDocument ? "" : t.element.css("overflow-x"),
                    ...
                    s = e === "scroll" || e === "auto" && t.width < t.element[0].scrollWidth,
                    n = i === "scroll" || i === "auto" && t.height < t.element[0].scrollHeight;
                return {
                    width: n ? I.position.scrollbarWidth() : 0,
        ...
        I.fn.position = function (c) {
            ...
            c = I.extend({}, c);
            var f, d, p, g, m, t, _ = I(c.of),
                v = I.position.getWithinInfo(c.within),
                b = I.position.getScrollInfo(v),
                y = (c.collision || "flip").split(" "),
                w = {};
            t = i(_);
            if (_[0].preventDefault) {
                c.at = "left top"
            }
            d = t.width;
            p = t.height;
            ...
            I.each(["my", "at"], function () {
                var t = (c[this] || "").split(" "),
                    e, i;
                if (t.length === 1) {
                    t = s.test(t[0]) ? t.concat(["center"]) : a.test(t[0]) ? ["center"].concat(t) : ["center", "center"]
                }
                ...
                c[this] = [r.exec(t[0])[0], r.exec(t[1])[0]]
            });
            if (y.length === 1) {
                y[1] = y[0]
            }
            ...
            return this.each(function () {
                var i, t, o = I(this),
                    ...
                    a = l + s + D(this, "marginBottom") + b.height,
                    h = I.extend({}, m),
                ...
                I.each(["left", "top"], function (t, e) {
                    if (I.ui.position[y[t]]) {
                        I.ui.position[y[t]][e](h, {
                            targetWidth: d,
                            targetHeight: p,
                            elemWidth: r,
                            elemHeight: l,
            ...
            fit: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        l;
                    if (e.collisionWidth > n) {
                        if (o > 0 && r <= 0) {
                            l = t.left + o + e.collisionWidth - n - s;
                            t.left += o - l
                        } else if (r > 0 && o <= 0) {
                            t.left = s
                        } else {
                            if (o > r) {
                                t.left = s + n - e.collisionWidth
                            } else {
                                t.left = s
                            }
                        }
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        l;
                    if (e.collisionHeight > n) {
                        if (o > 0 && r <= 0) {
                            l = t.top + o + e.collisionHeight - n - s;
                            t.top += o - l
                        } else if (r > 0 && o <= 0) {
                            t.top = s
                        } else {
                            if (o > r) {
                                t.top = s + n - e.collisionHeight
                            } else {
                                t.top = s
                            }
                        }
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        h = e.my[0] === "left" ? -e.elemWidth : e.my[0] === "right" ? e.elemWidth : 0,
                        u = e.at[0] === "left" ? e.targetWidth : e.at[0] === "right" ? -e.targetWidth : 0,
                        c = -2 * e.offset[0],
                        f, d;
                    if (r < 0) {
                        f = t.left + h + u + c + e.collisionWidth - n - s;
                        if (f < 0 || f < x(r)) {
                            t.left += h + u + c
                        }
                    } else if (l > 0) {
                        d = t.left - e.collisionPosition.marginLeft + h + u + c - a;
                        if (d > 0 || x(d) < l) {
                            t.left += h + u + c
                        }
                    }
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        h = e.my[1] === "top",
                        u = h ? -e.elemHeight : e.my[1] === "bottom" ? e.elemHeight : 0,
                        c = e.at[1] === "top" ? e.targetHeight : e.at[1] === "bottom" ? -e.targetHeight : 0,
                        f = -2 * e.offset[1],
                        d, p;
                    if (r < 0) {
                        p = t.top + u + c + f + e.collisionHeight - n - s;
                        if (p < 0 || p < x(r)) {
                            t.top += u + c + f
                        }
                    } else if (l > 0) {
                        d = t.top - e.collisionPosition.marginTop + u + c + f - a;
                        if (d > 0 || x(d) < l) {
                            t.top += u + c + f
                        }
                    }
    ...
    I.ui.focusable = function (t, e) {
        ...
        if ("area" === r) {
            ...
            n = I("img[usemap='#" + s + "']");
            return n.length > 0 && n.is(":visible")
        }
        if (/^(input|select|textarea|button|object)$/.test(r)) {
            a = !t.disabled;
            if (a) {
                o = I(t).closest("fieldset")[0];
                if (o) {
                    a = !o.disabled
                }
            }
    ...
    I.extend(I.expr[":"], {
        focusable: function (t) {
            return I.ui.focusable(t, I.attr(t, "tabindex") != null)
        }
    });
    var o = I.ui.focusable;
    var h = I.fn.form = function () {
        return typeof this[0].form === "string" ? this.closest("form") : I(this[0].form)
    };
    var u = I.ui.formResetMixin = {
    ...
    if (I.fn.jquery.substring(0, 3) === "1.7") {
        I.each(["Width", "Height"], function (t, i) {
            ...
            function o(t, e, i, s) {
                I.each(n, function () {
                    ...
                    if (i) {
                        e -= parseFloat(I.css(t, "border" + this + "Width")) || 0
                    }
                    if (s) {
                        e -= parseFloat(I.css(t, "margin" + this)) || 0
                    }
                });
                return e
            }
            I.fn["inner" + i] = function (t) {
                if (t === undefined) {
                    return a["inner" + i].call(this)
                }
                return this.each(function () {
                    I(this).css(s, o(this, t) + "px")
                })
            };
            I.fn["outer" + i] = function (t, e) {
                if (typeof t !== "number") {
                    return a["outer" + i].call(this, t)
                }
                return this.each(function () {
                    I(this).css(s, o(this, t, true, e) + "px")
                })
            }
        });
    ...
    var f = I.ui.escapeSelector = function () {
        var e = /([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g;
        return function (t) {
            return t.replace(e, "\\$1")
        }
    }();
    var d = I.fn.labels = function () {
        var t, e, i, s, n;
        ...
        if (i) {
            ...
            n = t.add(t.length ? t.siblings() : this.siblings());
            e = "label[for='" + I.ui.escapeSelector(i) + "']";
            s = s.add(n.find(e).addBack(e))
        }
        return this.pushStack(s)
    };
    var p = I.fn.scrollParent = function (t) {
        var e = this.css("position"),
            i = e === "absolute",
            s = t ? /(auto|scroll|hidden)/ : /(auto|scroll)/,
            n = this.parents().filter(function () {
                var t = I(this);
                if (i && t.css("position") === "static") {
                    return false
                }
                return s.test(t.css("overflow") + t.css("overflow-y") + t.css("overflow-x"))
            }).eq(0);
        return e === "fixed" || !n.length ? I(this[0].ownerDocument || document) : n
    };
    var g = I.extend(I.expr[":"], {
        tabbable: function (t) {
    ...
    var _ = I.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
    var v = false;
    I(document).on("mouseup", function () {
        v = false
    });
    var b = I.widget("ui.mouse", {
        version: "1.12.1",
        options: {
        ...
        _mouseInit: function () {
            ...
            this.element.on("mousedown." + this.widgetName, function (t) {
                ...
                if (true === I.data(t.target, e.widgetName + ".preventClickEvent")) {
        ...
        _mouseDown: function (t) {
            ...
            var e = this,
                i = t.which === 1,
                s = typeof this.options.cancel === "string" && t.target.nodeName ? I(t.target).closest(this.options.cancel).length : false;
            ...
            if (true === I.data(t.target, this.widgetName + ".preventClickEvent")) {
                I.removeData(t.target, this.widgetName + ".preventClickEvent")
            }
        ...
        _mouseUp: function (t) {
            ...
            if (this._mouseStarted) {
                ...
                if (t.target === this._mouseDownEvent.target) {
                    I.data(t.target, this.widgetName + ".preventClickEvent", true)
                }
                this._mouseStop(t)
            }
    ...
    var y = I.ui.plugin = {
        ...
        call: function (t, e, i, s) {
            ...
            if (!s && (!t.element[0].parentNode || t.element[0].parentNode.nodeType === 11)) {
                return
            }
            for (n = 0; n < a.length; n++) {
                if (t.options[a[n][0]]) {
                    a[n][1].apply(t.element, i)
                }
            }
        }
    };
    var w = I.ui.safeActiveElement = function (e) {
        var i;
        try {
            i = e.activeElement
        } catch (t) {
    ...
    var k = I.ui.safeBlur = function (t) {
    ...
    I.widget("ui.draggable", I.ui.mouse, {
        ...
        _mouseCapture: function (t) {
            var e = this.options;
            if (this.helper || e.disabled || I(t.target).closest(".ui-resizable-handle").length > 0) {
                return false
            }
            ...
            this._blockFrames(e.iframeFix === true ? "iframe" : e.iframeFix);
            return true
        },
        ...
        _mouseStart: function (t) {
            ...
            this._cacheHelperProportions();
            if (I.ui.ddmanager && !e.dropBehaviour) {
                I.ui.ddmanager.prepareOffsets(this, t)
            }
            this._mouseDrag(t, true);
            if (I.ui.ddmanager) {
                I.ui.ddmanager.dragStart(this, t)
            }
            return true
        },
        ...
        _mouseDrag: function (t, e) {
            ...
            if (!e) {
                var i = this._uiHash();
                if (this._trigger("drag", t, i) === false) {
                    this._mouseUp(new I.Event("mouseup", t));
                    return false
                }
        ...
        _mouseStop: function (t) {
            ...
            if (I.ui.ddmanager && !this.options.dropBehaviour) {
                i = I.ui.ddmanager.drop(this, t)
            }
            if (this.dropped) {
                i = this.dropped;
                this.dropped = false
            }
            if (this.options.revert === "invalid" && !i || this.options.revert === "valid" && i || this.options.revert === true || I.isFunction(this.options.revert) && this.options.revert.call(this.element, i)) {
                I(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function () {
                    if (e._trigger("stop", t) !== false) {
                        e._clear()
                    }
                })
            } else {
        ...
        _mouseUp: function (t) {
            this._unblockFrames();
            if (I.ui.ddmanager) {
                I.ui.ddmanager.dragStop(this, t)
            }
            if (this.handleElement.is(t.target)) {
                this.element.trigger("focus")
            }
            return I.ui.mouse.prototype._mouseUp.call(this, t)
        },
        cancel: function () {
        ...
        _getHandle: function (t) {
            return this.options.handle ? !!I(t.target).closest(this.element.find(this.options.handle)).length : true
        },
        ...
        _createHelper: function (t) {
            var e = this.options,
                ...
                s = i ? I(e.helper.apply(this.element[0], [t])) : e.helper === "clone" ? this.element.clone().removeAttr("id") : this.element;
            if (!s.parents("body").length) {
                s.appendTo(e.appendTo === "parent" ? this.element[0].parentNode : e.appendTo)
            }
            if (i && s[0] === this.element[0]) {
                this._setPositionRelative()
            }
        ...
        _getParentOffset: function () {
            var t = this.offsetParent.offset(),
                e = this.document[0];
            if (this.cssPosition === "absolute" && this.scrollParent[0] !== e && I.contains(this.scrollParent[0], this.offsetParent[0])) {
        ...
        _getRelativeOffset: function () {
            ...
            return {
                top: t.top - (parseInt(this.helper.css("top"), 10) || 0) + (!e ? this.scrollParent.scrollTop() : 0),
                left: t.left - (parseInt(this.helper.css("left"), 10) || 0) + (!e ? this.scrollParent.scrollLeft() : 0)
            }
        },
        ...
        _setContainment: function () {
            ...
            if (s.containment === "document") {
                this.containment = [0, 0, I(n).width() - this.helperProportions.width - this.margins.left, (I(n).height() || n.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];
                return
            }
        ...
        _convertPositionTo: function (t, e) {
            ...
            return {
                top: e.top + this.offset.relative.top * i + this.offset.parent.top * i - (this.cssPosition === "fixed" ? -this.offset.scroll.top : s ? 0 : this.offset.scroll.top) * i,
                left: e.left + this.offset.relative.left * i + this.offset.parent.left * i - (this.cssPosition === "fixed" ? -this.offset.scroll.left : s ? 0 : this.offset.scroll.left) * i
            }
        },
        ...
        _trigger: function (t, e, i) {
            i = i || this._uiHash();
            I.ui.plugin.call(this, t, [e, i, this], true);
            if (/^(drag|start|stop)/.test(t)) {
                this.positionAbs = this._convertPositionTo("absolute");
                i.offset = this.positionAbs
            }
            return I.Widget.prototype._trigger.call(this, t, e, i)
        },
        plugins: {},
        _uiHash: function () {
            return {
    ...
    I.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function (i, s, n) {
            I.each(n.sortables, function () {
                ...
                if (e._intersectsWith(e.containerCache)) {
                    t = true;
                    I.each(n.sortables, function () {
                        this.positionAbs = n.positionAbs;
                        this.helperProportions = n.helperProportions;
                        this.offset.click = n.offset.click;
                        if (this !== e && this._intersectsWith(this.containerCache) && I.contains(e.element[0], this.element[0])) {
                            t = false
                        }
                        return t
                    })
                ...
                if (t) {
                    if (!e.isOver) {
                        ...
                        e.currentItem = s.helper.appendTo(e.element).data("ui-sortable-item", true);
                        e.options._helper = e.options.helper;
                        e.options.helper = function () {
                            return s.helper[0]
                        };
                        i.target = e.currentItem[0];
                        e._mouseCapture(i, true);
                        e._mouseStart(i, true, true);
                    ...
                    if (e.isOver) {
                        ...
                        n._refreshOffsets(i);
                        s.position = n._generatePosition(i, true);
    ...
    I.ui.plugin.add("draggable", "opacity", {
        ...
        stop: function (t, e, i) {
            var s = i.options;
            if (s._opacity) {
                I(e.helper).css("opacity", s._opacity)
            }
        }
    });
    I.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function (t, e, i) {
            ...
            if (a !== o && a.tagName !== "HTML") {
                if (!s.axis || s.axis !== "x") {
                    if (i.overflowOffset.top + a.offsetHeight - t.pageY < s.scrollSensitivity) {
                        a.scrollTop = n = a.scrollTop + s.scrollSpeed
                    } else if (t.pageY - i.overflowOffset.top < s.scrollSensitivity) {
                        a.scrollTop = n = a.scrollTop - s.scrollSpeed
                    }
                }
                if (!s.axis || s.axis !== "y") {
                    if (i.overflowOffset.left + a.offsetWidth - t.pageX < s.scrollSensitivity) {
                        a.scrollLeft = n = a.scrollLeft + s.scrollSpeed
                    } else if (t.pageX - i.overflowOffset.left < s.scrollSensitivity) {
                        a.scrollLeft = n = a.scrollLeft - s.scrollSpeed
                    }
                }
            } else {
                if (!s.axis || s.axis !== "x") {
                    if (t.pageY - I(o).scrollTop() < s.scrollSensitivity) {
                        n = I(o).scrollTop(I(o).scrollTop() - s.scrollSpeed)
                    } else if (I(window).height() - (t.pageY - I(o).scrollTop()) < s.scrollSensitivity) {
                        n = I(o).scrollTop(I(o).scrollTop() + s.scrollSpeed)
                    }
                }
                if (!s.axis || s.axis !== "y") {
                    if (t.pageX - I(o).scrollLeft() < s.scrollSensitivity) {
                        n = I(o).scrollLeft(I(o).scrollLeft() - s.scrollSpeed)
                    } else if (I(window).width() - (t.pageX - I(o).scrollLeft()) < s.scrollSensitivity) {
                        n = I(o).scrollLeft(I(o).scrollLeft() + s.scrollSpeed)
                    }
                }
            }
            if (n !== false && I.ui.ddmanager && !s.dropBehaviour) {
                I.ui.ddmanager.prepareOffsets(i, t)
            }
        }
    });
    I.ui.plugin.add("draggable", "snap", {
        start: function (t, e, i) {
            var s = i.options;
            i.snapElements = [];
            I(s.snap.constructor !== String ? s.snap.items || ":data(ui-draggable)" : s.snap).each(function () {
                var t = I(this),
                    e = t.offset();
                if (this !== i.element[0]) {
                    i.snapElements.push({
        ...
        drag: function (t, e, i) {
            var s, n, a, o, r, l, h, u, c, f, d = i.options,
                p = d.snapTolerance,
                g = e.offset.left,
            ...
            for (c = i.snapElements.length - 1; c >= 0; c--) {
                r = i.snapElements[c].left - i.margins.left;
                l = r + i.snapElements[c].width;
                h = i.snapElements[c].top - i.margins.top;
                u = h + i.snapElements[c].height;
                if (m < r - p || g > l + p || v < h - p || _ > u + p || !I.contains(i.snapElements[c].item.ownerDocument, i.snapElements[c].item)) {
                    if (i.snapElements[c].snapping) {
                        i.options.snap.release && i.options.snap.release.call(i.element, t, I.extend(i._uiHash(), {
                            snapItem: i.snapElements[c].item
                        }))
                    }
                    i.snapElements[c].snapping = false;
                    continue
                }
                if (d.snapMode !== "inner") {
                    s = Math.abs(h - v) <= p;
                ...
                if (!i.snapElements[c].snapping && (s || n || a || o || f)) {
                    i.options.snap.snap && i.options.snap.snap.call(i.element, t, I.extend(i._uiHash(), {
                        snapItem: i.snapElements[c].item
                    }))
                }
                i.snapElements[c].snapping = s || n || a || o || f
            }
        }
    });
    I.ui.plugin.add("draggable", "stack", {
        start: function (t, e, i) {
            var s, n = i.options,
                a = I.makeArray(I(n.stack)).sort(function (t, e) {
                    return (parseInt(I(t).css("zIndex"), 10) || 0) - (parseInt(I(e).css("zIndex"), 10) || 0)
                });
            if (!a.length) {
                return
            }
            s = parseInt(I(a[0]).css("zIndex"), 10) || 0;
            I(a).each(function (t) {
    ...
    I.ui.plugin.add("draggable", "zIndex", {
        ...
        stop: function (t, e, i) {
            var s = i.options;
            if (s._zIndex) {
                I(e.helper).css("zIndex", s._zIndex)
            }
        }
    });
    ...
    I.widget("ui.droppable", {
        ...
        _create: function () {
            ...
            this.isover = false;
            this.isout = true;
            this.accept = I.isFunction(i) ? i : function (t) {
                return t.is(i)
            };
        ...
        _addToManager: function (t) {
            I.ui.ddmanager.droppables[t] = I.ui.ddmanager.droppables[t] || [];
            I.ui.ddmanager.droppables[t].push(this)
        },
        _splice: function (t) {
            var e = 0;
            for (; e < t.length; e++) {
        ...
        _setOption: function (t, e) {
            if (t === "accept") {
                this.accept = I.isFunction(e) ? e : function (t) {
                    return t.is(e)
                }
            } else if (t === "scope") {
        ...
        _activate: function (t) {
            ...
            if (e) {
                this._trigger("activate", t, this.ui(e))
            }
        },
        _deactivate: function (t) {
            ...
            if (e) {
                this._trigger("deactivate", t, this.ui(e))
            }
        },
        _over: function (t) {
            var e = I.ui.ddmanager.current;
        ...
        _drop: function (e, t) {
            ...
            this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                if (t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && C(i, I.extend(t, {
    ...
    var C = I.ui.intersect = function () {
        ...
        return function (t, e, i, s) {
            ...
            switch (i) {
                ...
                case "touch":
                    return (a >= h && a <= c || r >= h && r <= c || a < h && r > c) && (n >= l && n <= u || o >= l && o <= u || n < l && o > u);
                default:
                    return false
            }
        }
    ...
    I.ui.ddmanager = {
        ...
        drop: function (t, e) {
            var i = false;
            I.each((I.ui.ddmanager.droppables[t.options.scope] || []).slice(), function () {
                if (!this.options) {
                    return
                }
                if (!this.options.disabled && this.visible && C(t, this, this.options.tolerance, e)) {
        ...
        dragStart: function (t, e) {
            t.element.parentsUntil("body").on("scroll.droppable", function () {
                if (!t.options.refreshPositions) {
                    I.ui.ddmanager.prepareOffsets(t, e)
                }
            })
        },
        drag: function (a, o) {
            if (a.options.refreshPositions) {
                I.ui.ddmanager.prepareOffsets(a, o)
            }
            I.each(I.ui.ddmanager.droppables[a.options.scope] || [], function () {
                if (this.options.disabled || this.greedyChild || !this.visible) {
                    return
                }
                var t, e, i, s = C(a, this, this.options.tolerance, o),
                ...
                if (this.options.greedy) {
                    ...
                    if (i.length) {
                        t = I(i[0]).droppable("instance");
                        t.greedyChild = n === "isover"
                    }
                }
                if (t && n === "isover") {
                    t.isover = false;
                ...
                this[n === "isover" ? "_over" : "_out"].call(this, o);
                if (t && n === "isout") {
                    t.isout = false;
                    t.isover = true;
                    t._over.call(t, o)
    ...
    if (I.uiBackCompat !== false) {
        I.widget("ui.droppable", I.ui.droppable, {
            options: {
                hoverClass: false,
                activeClass: false
            },
    ...
    I.widget("ui.resizable", I.ui.mouse, {
        ...
        _hasScroll: function (t, e) {
            if (I(t).css("overflow") === "hidden") {
                return false
            }
            var i = e && e === "left" ? "scrollLeft" : "scrollTop",
                s = false;
            if (t[i] > 0) {
                return true
            }
        ...
        _create: function () {
            ...
            this._setupHandles();
            if (e.autoHide) {
                I(this.element).on("mouseenter", function () {
                    if (e.disabled) {
                        return
                    }
        ...
        _setupHandles: function () {
            var t = this.options,
                e, i, s, n, a, o = this;
            this.handles = t.handles || (!I(".ui-resizable-handle", this.element).length ? "e,s,se" : {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
            ...
            this._renderAxis = function (t) {
                ...
                for (e in this.handles) {
                    if (this.handles[e].constructor === String) {
                        this.handles[e] = this.element.children(this.handles[e]).first().show()
                    } else if (this.handles[e].jquery || this.handles[e].nodeType) {
                        this.handles[e] = I(this.handles[e]);
                        this._on(this.handles[e], {
                            mousedown: o._mouseDown
                        })
                    }
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i)) {
                        i = I(this.handles[e], this.element);
        ...
        _mouseCapture: function (t) {
            var e, i, s = false;
            for (e in this.handles) {
                i = I(this.handles[e])[0];
                if (i === t.target || I.contains(i, t.target)) {
                    s = true
                }
            }
        ...
        _mouseStart: function (t) {
            ...
            if (n.containment) {
                e += I(n.containment).scrollLeft() || 0;
                i += I(n.containment).scrollTop() || 0
            }
            ...
            s = I(".ui-resizable-" + this.axis).css("cursor");
            I("body").css("cursor", s === "auto" ? this.axis + "-resize" : s);
        ...
        _mouseStop: function (t) {
            ...
            if (this._helper) {
                ...
                s = i && this._hasScroll(e[0], "left") ? 0 : h.sizeDiff.height;
        ...
        _updateRatio: function (t) {
            ...
            } else if (this._isNumber(t.width)) {
        ...
        _proportionallyResize: function () {
            ...
            for (; e < this._proportionallyResizeElements.length; e++) {
        ...
        _propagate: function (t, e) {
            I.ui.plugin.call(this, t, [e, this.ui()]);
    ...
    I.ui.plugin.add("resizable", "animate", {
        stop: function (e) {
            ...
            i.element.animate(I.extend(r, h && l ? {
                top: h,
                left: l
            } : {}), {
    ...
    I.ui.plugin.add("resizable", "containment", {
        start: function () {
            var i, s, t, e, n, a, o, r = I(this).resizable("instance"),
                l = r.options,
                h = r.element,
                u = l.containment,
                c = u instanceof I ? u.get(0) : /parent/.test(u) ? h.parent().get(0) : u;
            if (!c) {
                return
            }
            r.containerElement = I(c);
            if (/document/.test(u) || u === document) {
                ...
                i = I(c);
                s = [];
                I(["Top", "Right", "Left", "Bottom"]).each(function (t, e) {
                ...
                a = r._hasScroll(c, "left") ? c.scrollWidth : n;
                o = r._hasScroll(c) ? c.scrollHeight : e;
                r.parentData = {
                    element: c,
                    left: t.left,
                    top: t.top,
        ...
        resize: function (t) {
            var e, i, s, n, a = I(this).resizable("instance"),
                o = a.options,
                r = a.containerOffset,
                l = a.position,
            ...
            if (l.left < (a._helper ? r.left : 0)) {
                a.size.width = a.size.width + (a._helper ? a.position.left - r.left : a.position.left - u.left);
                if (h) {
            ...
            e = Math.abs(a.sizeDiff.width + (a._helper ? a.offset.left - u.left : a.offset.left - r.left));
            i = Math.abs(a.sizeDiff.height + (a._helper ? a.offset.top - u.top : a.offset.top - r.top));
        ...
        stop: function () {
            ...
            if (t._helper && !e.animate && /relative/.test(n.css("position"))) {
                I(this).css({
            ...
            if (t._helper && !e.animate && /static/.test(n.css("position"))) {
                I(this).css({
                    left: o.left - s.left - i.left,
                    width: r,
                    height: l
    ...
    I.ui.plugin.add("resizable", "ghost", {
        start: function () {
            ...
            if (I.uiBackCompat !== false && typeof t.options.ghost === "string") {
        ...
        resize: function () {
            ...
            if (/^(se|s|e)$/.test(o)) {
                ...
                if (d - h > 0) {
                    ...
                    d = h - t.height;
                    e.size.height = d;
                    e.position.top = a.top + n.height - d
                }
                if (f - l > 0) {
                    e.size.width = f;
                    e.position.left = a.left - u
                    ...
                    f = l - t.width;
                    e.size.width = f;
                    e.position.left = a.left + n.width - f
                }
            }
        }
    });
    var T = I.ui.resizable;
    var P = I.widget("ui.selectable", I.ui.mouse, {
        version: "1.12.1",
        options: {
            appendTo: "body",
            autoRefresh: true,
        ...
        _create: function () {
            ...
            this.refresh = function () {
                s.elementPos = I(s.element[0]).offset();
                s.selectees = I(s.options.filter, s.element[0]);
        ...
        _mouseStart: function (i) {
            ...
            this.elementPos = I(this.element[0]).offset();
            if (this.options.disabled) {
                return
            }
            this.selectees = I(t.filter, this.element[0]);
            this._trigger("start", i);
            I(t.appendTo).append(this.helper);
            this.helper.css({
                left: i.pageX,
                top: i.pageY,
                width: 0,
        ...
        _mouseDrag: function (s) {
            ...
            this.selectees.each(function () {
                ...
                if (a.tolerance === "touch") {
                    e = !(i.left > l || i.right < o || i.top > h || i.bottom < r)
                } else if (a.tolerance === "fit") {
                    e = i.left > o && i.right < l && i.top > r && i.bottom < h
                }
                if (e) {
                    if (t.selected) {
                    ...
                    if (t.selecting) {
                        if ((s.metaKey || s.ctrlKey) && t.startselected) {
    ...
    var M = I.widget("ui.sortable", I.ui.mouse, {
        version: "1.12.1",
        ...
        _mouseCapture: function (t, e) {
            ...
            I(t.target).parents().each(function () {
                if (I.data(this, n.widgetName + "-item") === n) {
                    i = I(this);
                    return false
                }
            });
            if (I.data(t.target, n.widgetName + "-item") === n) {
                i = I(t.target)
            }
            if (!i) {
                return false
            ...
            if (this.options.handle && !e) {
                I(this.options.handle, i).find("*").addBack().each(function () {
                    if (this === t.target) {
                        s = true
                    }
                });
        ...
        _mouseStart: function (t, e, i) {
            ...
            if (a.cursor && a.cursor !== "auto") {
                ...
                this.storedStylesheet = I("<style>*{ cursor: " + a.cursor + " !important; }</style>").appendTo(n)
            }
            if (a.opacity) {
            ...
            if (I.ui.ddmanager && !a.dropBehaviour) {
                I.ui.ddmanager.prepareOffsets(this, t)
            }
            this.dragging = true;
        ...
        _mouseDrag: function (t) {
            ...
            if (this.options.scroll) {
                if (this.scrollParent[0] !== this.document[0] && this.scrollParent[0].tagName !== "HTML") {
                    ...
                    if (t.pageY - this.document.scrollTop() < a.scrollSensitivity) {
                        o = this.document.scrollTop(this.document.scrollTop() - a.scrollSpeed)
                    } else if (this.window.height() - (t.pageY - this.document.scrollTop()) < a.scrollSensitivity) {
                        o = this.document.scrollTop(this.document.scrollTop() + a.scrollSpeed)
                    }
                    if (t.pageX - this.document.scrollLeft() < a.scrollSensitivity) {
                        o = this.document.scrollLeft(this.document.scrollLeft() - a.scrollSpeed)
                    } else if (this.window.width() - (t.pageX - this.document.scrollLeft()) < a.scrollSensitivity) {
                        o = this.document.scrollLeft(this.document.scrollLeft() + a.scrollSpeed)
                    }
                }
                if (o !== false && I.ui.ddmanager && !a.dropBehaviour) {
                    I.ui.ddmanager.prepareOffsets(this, t)
                }
            }
            this.positionAbs = this._convertPositionTo("absolute");
            ...
            for (e = this.items.length - 1; e >= 0; e--) {
                ...
                if (i.instance !== this.currentContainer) {
                    continue
                }
                if (s !== this.currentItem[0] && this.placeholder[n === 1 ? "next" : "prev"]()[0] !== s && !I.contains(this.placeholder[0], s) && (this.options.type === "semi-dynamic" ? !I.contains(this.element[0], s) : true)) {
                    this.direction = n === 1 ? "down" : "up";
                    if (this.options.tolerance === "pointer" || this._intersectsWithSides(i)) {
                        this._rearrange(t, i)
                    } else {
                        break
                    }
        ...
        _mouseStop: function (t, e) {
            ...
            if (this.options.revert) {
                var i = this,
                    ...
                    a = {};
                if (!n || n === "x") {
                    a.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft)
                }
                if (!n || n === "y") {
                    a.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)
                }
                this.reverting = true;
                I(this.helper).animate(a, parseInt(this.options.revert, 10) || 500, function () {
                    i._clear(t)
                })
            } else {
                this._clear(t, e)
        ...
        serialize: function (e) {
            ...
            I(t).each(function () {
                ...
                if (t) {
                    i.push((e.key || t[1] + "[]") + "=" + (e.key && e.expression ? t[1] : t[2]))
                }
            });
            if (!i.length && e.key) {
                i.push(e.key + "=")
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left,
                ...
                c = this.options.axis === "x" || s + h > r && s + h < l,
                f = this.options.axis === "y" || e + u > a && e + u < o,
                d = c && f;
            if (this.options.tolerance === "pointer" || this.options.forcePointerForContainers || this.options.tolerance !== "pointer" && this.helperProportions[this.floating ? "width" : "height"] > t[this.floating ? "width" : "height"]) {
                ...
                return a < e + this.helperProportions.width / 2 && i - this.helperProportions.width / 2 < o && r < s + this.helperProportions.height / 2 && n - this.helperProportions.height / 2 < l
            }
        },
        _intersectsWithPointer: function (t) {
            var e, i, s = this.options.axis === "x" || this._isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                n = this.options.axis === "y" || this._isOverAxis(this.positionAbs.left + this.offset.click.left, t.left, t.width),
                a = s && n;
            if (!a) {
                return false
            }
            ...
            return this.floating ? i === "right" || e === "down" ? 2 : 1 : e && (e === "down" ? 2 : 1)
        },
        _intersectsWithSides: function (t) {
            ...
            if (this.floating && n) {
                return n === "right" && i || n === "left" && !i
            } else {
                return s && (s === "down" && e || s === "up" && !e)
            }
        },
        ...
        _getItemsAsjQuery: function (t) {
            ...
            if (r && t) {
                for (e = r.length - 1; e >= 0; e--) {
                    s = I(r[e], this.document[0]);
                    for (i = s.length - 1; i >= 0; i--) {
                        n = I.data(s[i], this.widgetFullName);
                        if (n && n !== this && !n.options.disabled) {
                            o.push([I.isFunction(n.options.items) ? n.options.items.call(n.element) : I(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n])
                        }
                    }
                }
            }
            o.push([I.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
        ...
        _refreshItems: function (t) {
            ...
            if (c && this.ready) {
                for (e = c.length - 1; e >= 0; e--) {
                    s = I(c[e], this.document[0]);
                    for (i = s.length - 1; i >= 0; i--) {
                        n = I.data(s[i], this.widgetFullName);
                        if (n && n !== this && !n.options.disabled) {
                            u.push([I.isFunction(n.options.items) ? n.options.items.call(n.element[0], t, {
                                item: this.currentItem
                            }) : I(n.options.items, n.element), n]);
        ...
        refreshPositions: function (t) {
            ...
            for (e = this.items.length - 1; e >= 0; e--) {
                ...
                s = this.options.toleranceElement ? I(this.options.toleranceElement, i.item) : i.item;
                if (!t) {
            ...
            if (!n.placeholder || n.placeholder.constructor === String) {
                ...
                n.placeholder = {
                    element: function () {
                        ...
                        if (t === "tbody") {
                            i._createTrPlaceholder(i.currentItem.find("tr").eq(0), I("<tr>", i.document[0]).appendTo(e))
                        } else if (t === "tr") {
                            i._createTrPlaceholder(i.currentItem, e)
                        } else if (t === "img") {
                            e.attr("src", i.currentItem.attr("src"))
                        }
                        if (!s) {
                    ...
                    update: function (t, e) {
                        ...
                        if (!e.width()) {
                            e.width(i.currentItem.innerWidth() - parseInt(i.currentItem.css("paddingLeft") || 0, 10) - parseInt(i.currentItem.css("paddingRight") || 0, 10))
                        }
                    }
                }
            }
            i.placeholder = I(n.placeholder.element.call(i.element, i.currentItem));
        ...
        _contactContainers: function (t) {
            ...
            for (e = this.containers.length - 1; e >= 0; e--) {
                ...
                if (this._intersectsWith(this.containers[e].containerCache)) {
                    if (c && I.contains(this.containers[e].element[0], c.element[0])) {
                        continue
                    }
                    c = this.containers[e];
                    f = e
            ...
            if (this.containers.length === 1) {
                ...
                s = 1e4;
                n = null;
                h = c.floating || this._isFloating(this.currentItem);
                a = h ? "left" : "top";
                o = h ? "width" : "height";
                u = h ? "pageX" : "pageY";
                for (i = this.items.length - 1; i >= 0; i--) {
                    if (!I.contains(this.containers[f].element[0], this.items[i].item[0])) {
                        continue
                    }
                ...
                n ? this._rearrange(t, n, null, true) : this._rearrange(t, null, this.containers[f].element, true);
                this._trigger("change", t, this._uiHash());
        ...
        _createHelper: function (t) {
            var e = this.options,
                i = I.isFunction(e.helper) ? I(e.helper.apply(this.element[0], [t, this.currentItem])) : e.helper === "clone" ? this.currentItem.clone() : this.currentItem;
            if (!i.parents("body").length) {
                I(e.appendTo !== "parent" ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(i[0])
            }
            ...
            if (!i[0].style.width || e.forceHelperSize) {
                i.width(this.currentItem.width())
            }
            if (!i[0].style.height || e.forceHelperSize) {
        ...
        _setContainment: function () {
            ...
            if (!/^(document|window|parent)$/.test(s.containment)) {
                t = I(s.containment)[0];
                e = I(s.containment).offset();
                i = I(t).css("overflow") !== "hidden";
        ...
        _convertPositionTo: function (t, e) {
            ...
            var i = t === "absolute" ? 1 : -1,
                s = this.cssPosition === "absolute" && !(this.scrollParent[0] !== this.document[0] && I.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
                n = /(html|body)/i.test(s[0].tagName);
            return {
                top: e.top + this.offset.relative.top * i + this.offset.parent.top * i - (this.cssPosition === "fixed" ? -this.scrollParent.scrollTop() : n ? 0 : s.scrollTop()) * i,
                left: e.left + this.offset.relative.left * i + this.offset.parent.left * i - (this.cssPosition === "fixed" ? -this.scrollParent.scrollLeft() : n ? 0 : s.scrollLeft()) * i
            }
        },
        _generatePosition: function (t) {
            var e, i, s = this.options,
                n = t.pageX,
                a = t.pageY,
                o = this.cssPosition === "absolute" && !(this.scrollParent[0] !== this.document[0] && I.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
            ...
            if (this.originalPosition) {
                ...
                if (s.grid) {
                    e = this.originalPageY + Math.round((a - this.originalPageY) / s.grid[1]) * s.grid[1];
            ...
            return {
                ...
                left: n - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (this.cssPosition === "fixed" ? -this.scrollParent.scrollLeft() : r ? 0 : o.scrollLeft())
            }
        },
        ...
        _clear: function (t, e) {
            ...
            for (i = this.containers.length - 1; i >= 0; i--) {
                if (!e) {
                    s.push(n("deactivate", this, this.containers[i]))
                }
    ...
    var S = I.widget("ui.accordion", {
        ...
        _setOption: function (t, e) {
            ...
            this._super(t, e);
            if (t === "collapsible" && !e && this.options.active === false) {
                this._activate(0)
            }
            if (t === "icons") {
                this._destroyIcons();
        ...
        _panelKeyDown: function (t) {
            if (t.keyCode === I.ui.keyCode.UP && t.ctrlKey) {
                I(t.currentTarget).prev().trigger("focus")
            }
        },
        refresh: function () {
            var t = this.options;
            ...
            if (t.active === false && t.collapsible === true || !this.headers.length) {
                ...
                this._activate(0)
            } else if (this.active.length && !I.contains(this.element[0], this.active[0])) {
        ...
        _refresh: function () {
            ...
            if (e === "fill") {
                ...
                this.headers.next().each(function () {
                    ...
                    i = Math.max(i, I(this).css("height", "").height());
                    if (!t) {
                        I(this).hide()
                    }
                }).height(i)
        ...
        _findActive: function (t) {
            return typeof t === "number" ? this.headers.eq(t) : I()
        },
        ...
        _eventHandler: function (t) {
            ...
            t.preventDefault();
            if (o && !s.collapsible || this._trigger("beforeActivate", t, u) === false) {
                return
            }
            s.active = r ? false : this.headers.index(a);
            this.active = o ? I() : a;
            this._toggle(u);
        ...
        _animate: function (t, i, e) {
            ...
            if (!i.length) {
                return t.animate(this.showProps, a, n, f)
            }
            if (!t.length) {
                return i.animate(this.hideProps, a, n, f)
            }
    ...
    var H = I.widget("ui.menu", {
        ...
        _create: function () {
            ...
            this._on({
                ...
                "click .ui-menu-item": function (t) {
                    var e = I(t.target);
                    var i = I(I.ui.safeActiveElement(this.document[0]));
                    if (!this.mouseHandled && e.not(".ui-state-disabled").length) {
                        this.select(t);
            ...
            this._on(this.document, {
                click: function (t) {
                    if (this._closeOnDocumentClick(t)) {
                        this.collapseAll(t)
                    }
                    this.mouseHandled = false
                }
        ...
        _destroy: function () {
            var t = this.element.find(".ui-menu-item").removeAttr("role aria-disabled"),
                e = t.children(".ui-menu-item-wrapper").removeUniqueId().removeAttr("tabIndex role aria-haspopup");
            this.element.removeAttr("aria-activedescendant").find(".ui-menu").addBack().removeAttr("role aria-labelledby aria-expanded aria-hidden aria-disabled " + "tabIndex").removeUniqueId().show();
            e.children().each(function () {
                var t = I(this);
                if (t.data("ui-menu-submenu-caret")) {
                    t.remove()
                }
            })
        },
        _keydown: function (t) {
            ...
            switch (t.keyCode) {
                ...
                default:
                    ...
                    e = n && e.index(this.active.next()) !== -1 ? this.active.nextAll(".ui-menu-item") : e;
                    if (!e.length) {
        ...
        refresh: function () {
            ...
            i = r.filter(":not(.ui-menu)").hide().attr({
                ...
                var t = I(this),
                    e = t.prev(),
                    i = I("<span>").data("ui-menu-submenu-caret", true);
            ...
            s = e.not(".ui-menu-item, .ui-menu-divider");
            n = s.children().not(".ui-menu").uniqueId().attr({
                tabIndex: -1,
                role: this._itemRole()
            });
        ...
        focus: function (t, e) {
            ...
            if (i.length && t && /^mouse/.test(t.type)) {
        ...
        _scrollIntoView: function (t) {
            var e, i, s, n, a, o;
            if (this._hasScroll()) {
                e = parseFloat(I.css(this.activeMenu[0], "borderTopWidth")) || 0;
                i = parseFloat(I.css(this.activeMenu[0], "paddingTop")) || 0;
                ...
                if (s < 0) {
                    ...
                    this.activeMenu.scrollTop(n + s - a + o)
                }
            }
        },
        blur: function (t, e) {
    ...
    I.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this._initSource();
            this.menu = I("<ul>").appendTo(this._appendTo()).menu({
                role: null
            }).hide().menu("instance");
            ...
            this._on(this.menu.element, {
                mousedown: function (t) {
                    ...
                    this._delay(function () {
                        delete this.cancelBlur;
                        if (this.element[0] !== I.ui.safeActiveElement(this.document[0])) {
                            this.element.trigger("focus")
                        }
                    })
                },
                menufocus: function (t, e) {
                    ...
                    if (i && I.trim(i).length) {
                        ...
                        I("<div>").text(i).appendTo(this.liveRegion)
                    }
                },
                menuselect: function (t, e) {
                    ...
                    if (false !== this._trigger("select", t, {
                            item: i
                        })) {
                        this._value(i.value)
                    }
        ...
        _closeOnClickOutside: function (t) {
            if (!this._isEventTargetInWidget(t)) {
                this.close()
            }
        },
        _appendTo: function () {
            ...
            if (t) {
                t = t.jquery || t.nodeType ? I(t) : this.document.find(t).eq(0)
            }
            if (!t || !t[0]) {
        ...
        _isContentEditable: function (t) {
            ...
            if (e === "inherit") {
                return this._isContentEditable(t.parent())
            }
            return e === "true"
        }
    });
    ...
    I.widget("ui.autocomplete", I.ui.autocomplete, {
        ...
        __response: function (t) {
            ...
            this.liveRegion.children().hide();
            I("<div>").text(e).appendTo(this.liveRegion)
        }
    });
    var z = I.ui.autocomplete;
    var O = /ui-corner-([a-z]){2,6}/g;
    var A = I.widget("ui.controlgroup", {
        version: "1.12.1",
        defaultElement: "<div>",
        options: {
        ...
        _initWidgets: function () {
            ...
            I.each(this.options.items, function (n, t) {
                ...
                if (n === "controlgroupLabel") {
                    ...
                    e.each(function () {
                        var t = I(this);
                        if (t.children(".ui-controlgroup-label-contents").length) {
                            return
                        }
                ...
                o.element.find(t).each(function () {
                    var t = I(this);
                    var e = t[n]("instance");
                    var i = I.widget.extend({}, a);
                    if (n === "button" && t.parent(".ui-spinner").length) {
                        return
                    }
                    if (!e) {
                        e = t[n]()[n]("instance")
                    ...
                    t[n](i);
                    var s = t[n]("widget");
                    I.data(s[0], "ui-controlgroup-data", e ? e : t[n]("instance"));
                    r.push(s[0])
                })
            });
            this.childWidgets = I(I.unique(r));
            this._addClass(this.childWidgets, "ui-controlgroup-item")
        },
        _callChildMethod: function (i) {
            this.childWidgets.each(function () {
                var t = I(this),
                    e = t.data("ui-controlgroup-data");
                if (e && e[i]) {
                    e[i]()
                }
            })
        ...
        _selectmenuOptions: function (t) {
            var e = this.options.direction === "vertical";
            return {
                width: e ? "auto" : false,
                classes: {
                    middle: {
        ...
        refresh: function () {
            ...
            if (n.length) {
                I.each(["first", "last"], function (t, e) {
                    var i = n[e]().data("ui-controlgroup-data");
                    if (i && a["_" + i.widgetName + "Options"]) {
                        var s = a["_" + i.widgetName + "Options"](n.length === 1 ? "only" : e);
    ...
    I.widget("ui.checkboxradio", [I.ui.formResetMixin, {
        ...
        _getCreateOptions: function () {
            ...
            this.label = I(e[e.length - 1]);
            if (!this.label.length) {
                I.error("No label found for checkboxradio widget")
            }
            this.originalLabel = "";
            this.label.contents().not(this.element[0]).each(function () {
                i.originalLabel += this.nodeType === 3 ? I(this).text() : this.outerHTML
            });
            if (this.originalLabel) {
                s.label = this.originalLabel
            }
        ...
        _readType: function () {
            ...
            if (t !== "input" || !/radio|checkbox/.test(this.type)) {
                I.error("Can't create checkboxradio on element.nodeName=" + t + " and element.type=" + this.type)
            }
        },
        _enhance: function () {
        ...
        _getRadioGroup: function () {
            ...
            var i = "input[name='" + I.ui.escapeSelector(e) + "']";
            if (!e) {
                return I([])
            }
            if (this.form.length) {
                t = I(this.form[0].elements).filter(i)
            } else {
                t = I(i).filter(function () {
                    return I(this).form().length === 0
                })
            }
            return t.not(this.element)
        },
        _toggleClasses: function () {
            ...
            if (this.type === "radio") {
                this._getRadioGroup().each(function () {
                    ...
                    if (t) {
                        t._removeClass(t.label, "ui-checkboxradio-checked", "ui-state-active")
                    }
                })
            }
        },
    ...
    I.widget("ui.button", {
        ...
        _create: function () {
            ...
            if (this.element.is("a")) {
                this._on({
                    keyup: function (t) {
                        if (t.keyCode === I.ui.keyCode.SPACE) {
                            t.preventDefault();
        ...
        _updateIcon: function (t, e) {
            ...
            if (i) {
                this._addClass(this.icon, null, e)
            }
            this._attachIcon(s);
            if (n) {
    ...
    if (I.uiBackCompat !== false) {
        I.widget("ui.button", I.ui.button, {
            options: {
                text: true,
                icons: {
                    primary: null,
        ...
        I.fn.button = function (t) {
            return function () {
                ...
                if (!I.ui.checkboxradio) {
                    I.error("Checkboxradio widget missing")
                }
                if (arguments.length === 0) {
        ...
        I.fn.buttonset = function () {
            if (!I.ui.controlgroup) {
                I.error("Controlgroup widget missing")
            }
    ...
    function L() {
        ...
        this.dpDiv = R(I("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    I.extend(L.prototype, {
        ...
        _attachDatepicker: function (t, e) {
            ...
            n = this._newInst(I(t), s);
            n.settings = I.extend({}, e || {});
            if (i === "input") {
                this._connectDatepicker(t, n)
            } else if (s) {
                this._inlineDatepicker(t, n)
            }
        },
        _newInst: function (t, e) {
            ...
            return {
                ...
                drawYear: 0,
                inline: e,
                dpDiv: !e ? this.dpDiv : R(I("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
            }
        },
        _connectDatepicker: function (t, e) {
            ...
            this._autoSize(e);
            I.data(t, "datepicker", e);
            if (e.settings.disabled) {
                this._disableDatepicker(t)
            }
        },
        _attachments: function (t, e) {
            var i, s, n, a = this._get(e, "appendText"),
                o = this._get(e, "isRTL");
            if (e.append) {
                e.append.remove()
            }
            if (a) {
                e.append = I("<span class='" + this._appendClass + "'>" + a + "</span>");
            ...
            if (i === "button" || i === "both") {
                ...
                e.trigger = I(this._get(e, "buttonImageOnly") ? I("<img/>").addClass(this._triggerClass).attr({
                    src: n,
                    alt: s,
                    title: s
                }) : I("<button type='button'></button>").addClass(this._triggerClass).html(!n ? s : I("<img/>").attr({
                    src: n,
                    alt: s,
                    title: s
                })));
                ...
                e.trigger.on("click", function () {
                    if (I.datepicker._datepickerShowing && I.datepicker._lastInput === t[0]) {
                        I.datepicker._hideDatepicker()
                    } else if (I.datepicker._datepickerShowing && I.datepicker._lastInput !== t[0]) {
                        I.datepicker._hideDatepicker();
                        I.datepicker._showDatepicker(t[0])
                    } else {
                        I.datepicker._showDatepicker(t[0])
                    }
                    return false
        ...
        _autoSize: function (t) {
            if (this._get(t, "autoSize") && !t.inline) {
                var e, i, s, n, a = new Date(2009, 12 - 1, 20),
        ...
        _dialogDatepicker: function (t, e, i, s, n) {
            var a, o, r, l, h, u = this._dialogInst;
            if (!u) {
                this.uuid += 1;
                a = "dp" + this.uuid;
                this._dialogInput = I("<input type='text' id='" + a + "' style='position: absolute; top: -100px; width: 0px;'/>");
                this._dialogInput.on("keydown", this._doKeyDown);
                I("body").append(this._dialogInput);
                u = this._dialogInst = this._newInst(this._dialogInput, false);
                u.settings = {};
                I.data(this._dialogInput[0], "datepicker", u)
            }
            Y(u.settings, s || {});
        ...
        _enableDatepicker: function (e) {
            ...
            this._disabledInputs = I.map(this._disabledInputs, function (t) {
                return t === e ? null : t
            })
        },
        ...
        _optionDatepicker: function (t, e, i) {
            ...
            if (arguments.length === 2 && typeof e === "string") {
                return e === "defaults" ? I.extend({}, I.datepicker._defaults) : r ? e === "all" ? I.extend({}, r.settings) : this._get(r, e) : null
            }
            s = e || {};
            if (typeof e === "string") {
                s = {};
            ...
            if (r) {
                ...
                n = this._getDateDatepicker(t, true);
                a = this._getMinMaxDate(r, "min");
                o = this._getMinMaxDate(r, "max");
                Y(r.settings, s);
                if (a !== null && s.dateFormat !== undefined && s.minDate === undefined) {
                    r.settings.minDate = this._formatDate(r, a)
                }
                if (o !== null && s.dateFormat !== undefined && s.maxDate === undefined) {
                    r.settings.maxDate = this._formatDate(r, o)
                }
                if ("disabled" in s) {
                    if (s.disabled) {
                        this._disableDatepicker(t)
            ...
            if (I.datepicker._datepickerShowing) {
                switch (t.keyCode) {
                    case 9:
                        ...
                        break;
                    case 13:
                        s = I("td." + I.datepicker._dayOverClass + ":not(." + I.datepicker._currentClass + ")", n.dpDiv);
                        if (s[0]) {
                            I.datepicker._selectDay(t.target, n.selectedMonth, n.selectedYear, s[0])
                        }
                        e = I.datepicker._get(n, "onSelect");
                        if (e) {
                            i = I.datepicker._formatDate(n);
                    ...
                    case 35:
                        if (t.ctrlKey || t.metaKey) {
                            I.datepicker._clearDate(t.target)
                        }
                        a = t.ctrlKey || t.metaKey;
                        break;
                    case 36:
                        if (t.ctrlKey || t.metaKey) {
                            I.datepicker._gotoToday(t.target)
                        }
                        a = t.ctrlKey || t.metaKey;
                        break;
                    case 37:
                        if (t.ctrlKey || t.metaKey) {
                            I.datepicker._adjustDate(t.target, o ? +1 : -1, "D")
                        }
                        a = t.ctrlKey || t.metaKey;
                    ...
                    case 38:
                        if (t.ctrlKey || t.metaKey) {
                            I.datepicker._adjustDate(t.target, -7, "D")
                        }
                        a = t.ctrlKey || t.metaKey;
                        break;
                    case 39:
        ...
        _doKeyPress: function (t) {
            ...
            if (I.datepicker._get(s, "constrainInput")) {
                e = I.datepicker._possibleChars(I.datepicker._get(s, "dateFormat"));
        ...
        _doKeyUp: function (t) {
            ...
            if (i.input.val() !== i.lastVal) {
                try {
                    e = I.datepicker.parseDate(I.datepicker._get(i, "dateFormat"), i.input ? i.input.val() : null, I.datepicker._getFormatConfig(i));
                    if (e) {
                        I.datepicker._setDateFromField(i);
                        I.datepicker._updateAlternate(i);
                        I.datepicker._updateDatepicker(i)
                    }
                } catch (t) {}
            }
            return true
        ...
        _showDatepicker: function (t) {
            ...
            if (t.nodeName.toLowerCase() !== "input") {
                t = I("input", t.parentNode)[0]
            }
            if (I.datepicker._isDisabledDatepicker(t) || I.datepicker._lastInput === t) {
                return
            }
            var e, i, s, n, a, o, r;
            e = I.datepicker._getInst(t);
            if (I.datepicker._curInst && I.datepicker._curInst !== e) {
                I.datepicker._curInst.dpDiv.stop(true, true);
                if (e && I.datepicker._datepickerShowing) {
                    I.datepicker._hideDatepicker(I.datepicker._curInst.input[0])
                }
            }
            i = I.datepicker._get(e, "beforeShow");
            s = i ? i.apply(t, [t, e]) : {};
            if (s === false) {
                return
            }
            Y(e.settings, s);
            e.lastVal = null;
            I.datepicker._lastInput = t;
            I.datepicker._setDateFromField(e);
            if (I.datepicker._inDialog) {
                t.value = ""
            }
            if (!I.datepicker._pos) {
                I.datepicker._pos = I.datepicker._findPos(t);
                I.datepicker._pos[1] += t.offsetHeight
            }
            n = false;
            I(t).parents().each(function () {
                n |= I(this).css("position") === "fixed";
                return !n
            });
            a = {
            ...
            I.datepicker._updateDatepicker(e);
            a = I.datepicker._checkOffset(e, a, n);
            e.dpDiv.css({
            ...
            if (!e.inline) {
                o = I.datepicker._get(e, "showAnim");
                r = I.datepicker._get(e, "duration");
                e.dpDiv.css("z-index", F(I(t)) + 1);
                I.datepicker._datepickerShowing = true;
                if (I.effects && I.effects.effect[o]) {
                    e.dpDiv.show(o, I.datepicker._get(e, "showOptions"), r)
                } else {
                    e.dpDiv[o || "show"](o ? r : null)
                }
                if (I.datepicker._shouldFocusInput(e)) {
                    e.input.trigger("focus")
                }
                I.datepicker._curInst = e
            }
        },
        _updateDatepicker: function (t) {
            ...
            if (t === I.datepicker._curInst && I.datepicker._datepickerShowing && I.datepicker._shouldFocusInput(t)) {
                t.input.trigger("focus")
            }
            if (t.yearshtml) {
                e = t.yearshtml;
                setTimeout(function () {
                    if (e === t.yearshtml && t.yearshtml) {
        ...
        _checkOffset: function (t, e, i) {
            var s = t.dpDiv.outerWidth(),
                ...
                l = document.documentElement.clientHeight + (i ? 0 : I(document).scrollTop());
            e.left -= this._get(t, "isRTL") ? s - a : 0;
            e.left -= i && e.left === t.input.offset().left ? I(document).scrollLeft() : 0;
            e.top -= i && e.top === t.input.offset().top + o ? I(document).scrollTop() : 0;
            e.left -= Math.min(e.left, e.left + s > r && r > s ? Math.abs(e.left + s - r) : 0);
            e.top -= Math.min(e.top, e.top + n > l && l > n ? Math.abs(n + o) : 0);
            return e
        },
        _findPos: function (t) {
            var e, i = this._getInst(t),
                s = this._get(i, "isRTL");
            while (t && (t.type === "hidden" || t.nodeType !== 1 || I.expr.filters.hidden(t))) {
        ...
        _hideDatepicker: function (t) {
            ...
            if (this._datepickerShowing) {
                ...
                if (I.effects && (I.effects.effect[e] || I.effects[e])) {
                    a.dpDiv.hide(e, I.datepicker._get(a, "showOptions"), i, s)
                } else {
                    a.dpDiv[e === "slideDown" ? "slideUp" : e === "fadeIn" ? "fadeOut" : "hide"](e ? i : null, s)
                }
                if (!e) {
                    s()
                }
                this._datepickerShowing = false;
                n = this._get(a, "onClose");
                if (n) {
                    n.apply(a.input ? a.input[0] : null, [a.input ? a.input.val() : "", a])
                }
        ...
        _checkExternalClick: function (t) {
            ...
            if (e[0].id !== I.datepicker._mainDivId && e.parents("#" + I.datepicker._mainDivId).length === 0 && !e.hasClass(I.datepicker.markerClassName) && !e.closest("." + I.datepicker._triggerClass).length && I.datepicker._datepickerShowing && !(I.datepicker._inDialog && I.blockUI) || e.hasClass(I.datepicker.markerClassName) && I.datepicker._curInst !== i) {
                I.datepicker._hideDatepicker()
            }
        },
        _adjustDate: function (t, e, i) {
            ...
            this._adjustInstDate(n, e + (i === "M" ? this._get(n, "showCurrentAtPos") : 0), i);
        ...
        _selectMonthYear: function (t, e, i) {
            var s = I(t),
                n = this._getInst(s[0]);
            n["selected" + (i === "M" ? "Month" : "Year")] = n["draw" + (i === "M" ? "Month" : "Year")] = parseInt(e.options[e.selectedIndex].value, 10);
            this._notifyChange(n);
            this._adjustDate(s)
        },
        _selectDay: function (t, e, i, s) {
            var n, a = I(t);
            if (I(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(a[0])) {
                return
            }
            n = this._getInst(a[0]);
            n.selectedDay = n.currentDay = I("a", s).html();
        ...
        iso8601Week: function (t) {
            ...
            i.setMonth(0);
            i.setDate(1);
            return Math.floor(Math.round((e - i) / 864e5) / 7) + 1
        },
        parseDate: function (i, o, t) {
                ...
                if (_) {
                    ...
                    switch (i.charAt(s)) {
                        ...
                        case "@":
                            ...
                            break;
                        case "!":
                            v = new Date((y("!") - this._ticksTo1970) / 1e4);
                            d = v.getFullYear();
                            p = v.getMonth() + 1;
                            g = v.getDate();
                            break;
            ...
            if (d === -1) {
                ...
                d += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (d <= l ? 0 : -100)
            }
            if (m > -1) {
                p = 1;
                g = m;
                do {
                    e = this._getDaysInMonth(d, p - 1);
                    if (g <= e) {
                        break
                    }
                    p++;
            ...
            v = this._daylightSavingAdjust(new Date(d, p - 1, g));
            if (v.getFullYear() !== d || v.getMonth() + 1 !== p || v.getDate() !== g) {
                throw "Invalid date"
            }
            return v
        },
        ...
        _determineDate: function (r, t, e) {
            var i = function (t) {
                ...
                s = function (t) {
                    ...
                    var e = (t.toLowerCase().match(/^c/) ? I.datepicker._getDate(r) : null) || new Date,
                        i = e.getFullYear(),
                        s = e.getMonth(),
                        n = e.getDate(),
                    ...
                    while (o) {
                        switch (o[2] || "d") {
                            ...
                            case "M":
                                s += parseInt(o[1], 10);
                                n = Math.min(n, I.datepicker._getDaysInMonth(i, s));
                                break;
                            case "y":
                            case "Y":
                                i += parseInt(o[1], 10);
                ...
                n = t == null || t === "" ? e : typeof t === "string" ? s(t) : typeof t === "number" ? isNaN(t) ? e : i(t) : new Date(t.getTime());
            n = n && n.toString() === "Invalid Date" ? e : n;
            if (n) {
                n.setHours(0);
                n.setMinutes(0);
                n.setSeconds(0);
        ...
        _setDate: function (t, e, i) {
            ...
            if ((n !== t.selectedMonth || a !== t.selectedYear) && !i) {
        ...
        _attachHandlers: function (t) {
            ...
            t.dpDiv.find("[data-handler]").map(function () {
                var t = {
                    ...
                    selectDay: function () {
                        I.datepicker._selectDay(i, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this);
                        return false
                    },
                    selectMonth: function () {
                        I.datepicker._selectMonthYear(i, this, "M");
                        return false
                    },
                    selectYear: function () {
                        I.datepicker._selectMonthYear(i, this, "Y");
                        return false
                    }
                };
        ...
        _generateHTML: function (t) {
            var e, i, s, n, a, o, r, l, h, u, c, f, d, p, g, m, _, v, b, y, w, k, x, C, D, I, T, P, M, S, H, z, O, A, N, W, E, F, L, R = new Date,
                ...
                X = U[0] !== 1 || U[1] !== 1,
                G = this._daylightSavingAdjust(!t.currentDay ? new Date(9999, 9, 9) : new Date(t.currentYear, t.currentMonth, t.currentDay)),
            ...
            if (J) {
                ...
                e = Q && e < Q ? Q : e;
                while (this._daylightSavingAdjust(new Date(tt, Z, 1)) > e) {
                    Z--;
                    if (Z < 0) {
                        Z = 11;
                        tt--
            ...
            i = !K ? i : this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - $, 1)), this._getFormatConfig(t));
            ...
            n = !K ? n : this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + $, 1)), this._getFormatConfig(t));
            a = this._canAdjustMonth(t, +1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" + " title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>";
            o = this._get(t, "currentText");
            r = this._get(t, "gotoCurrent") && t.currentDay ? G : B;
            o = !K ? o : this.formatDate(o, r, this._getFormatConfig(t));
            l = !t.inline ? "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>" : "";
            h = j ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'" + ">" + o + "</button>" : "") + (Y ? "" : l) + "</div>" : "";
            ...
            for (k = 0; k < U[0]; k++) {
                ...
                for (C = 0; C < U[1]; C++) {
                    ...
                    T += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I + "'>" + (/all|left/.test(I) && k === 0 ? Y ? a : s : "") + (/all|right/.test(I) && k === 0 ? Y ? s : a : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, k > 0 || C > 0, p, g) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>";
                    P = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "";
                    for (w = 0; w < 7; w++) {
                        M = (w + u) % 7;
                        P += "<th scope='col'" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + f[M] + "'>" + d[M] + "</span></th>"
                    }
                    T += P + "</tr></thead><tbody>";
                    S = this._getDaysInMonth(tt, Z);
                    if (tt === t.selectedYear && Z === t.selectedMonth) {
                        t.selectedDay = Math.min(t.selectedDay, S)
                    }
                    H = (this._getFirstDayOfMonth(tt, Z) - u + 7) % 7;
                    z = Math.ceil((H + S) / 7);
                    ...
                    for (N = 0; N < O; N++) {
                        T += "<tr>";
                        W = !c ? "" : "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(A) + "</td>";
                        for (w = 0; w < 7; w++) {
                            E = m ? m.apply(t.input ? t.input[0] : null, [A]) : [true, ""];
                            F = A.getMonth() !== Z;
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, a, o, r) {
            var l, h, u, c, f, d, p, g, m = this._get(t, "changeMonth"),
            ...
            if (a || !m) {
                ...
                for (u = 0; u < 12; u++) {
                    if ((!l || u >= s.getMonth()) && (!h || u <= n.getMonth())) {
        ...
        _adjustInstDate: function (t, e, i) {
            var s = t.selectedYear + (i === "Y" ? e : 0),
                n = t.selectedMonth + (i === "M" ? e : 0),
                a = Math.min(t.selectedDay, this._getDaysInMonth(s, n)) + (i === "D" ? e : 0),
        ...
        _isInRange: function (t, e) {
            ...
            return (!n || e.getTime() >= n.getTime()) && (!a || e.getTime() <= a.getTime()) && (!o || e.getFullYear() >= o) && (!r || e.getFullYear() <= r)
        },
    ...
    function B() {
        if (!I.datepicker._isDisabledDatepicker(E.inline ? E.dpDiv.parent()[0] : E.input[0])) {
    ...
    I.fn.datepicker = function (t) {
        ...
        if (!I.datepicker.initialized) {
            I(document).on("mousedown", I.datepicker._checkExternalClick);
        ...
        if (typeof t === "string" && (t === "isDisabled" || t === "getDate" || t === "widget")) {
            return I.datepicker["_" + t + "Datepicker"].apply(I.datepicker, [this[0]].concat(e))
        }
        if (t === "option" && arguments.length === 2 && typeof arguments[1] === "string") {
            return I.datepicker["_" + t + "Datepicker"].apply(I.datepicker, [this[0]].concat(e))
        }
        return this.each(function () {
            typeof t === "string" ? I.datepicker["_" + t + "Datepicker"].apply(I.datepicker, [this].concat(e)) : I.datepicker._attachDatepicker(this, t)
        })
    };
    I.datepicker = new L;
    I.datepicker.initialized = false;
    I.datepicker.uuid = (new Date).getTime();
    I.datepicker.version = "1.12.1";
    var j = I.datepicker;
    I.widget("ui.dialog", {
        version: "1.12.1",
        options: {
        ...
        _moveToTop: function (t, e) {
            ...
            if (n >= +this.uiDialog.css("z-index")) {
                this.uiDialog.css("z-index", n + 1);
                i = true
            }
            if (i && !e) {
                this._trigger("focus", t)
            ...
            this._on(this.uiDialog, {
                keydown: function (t) {
                    ...
                    var e = this.uiDialog.find(":tabbable"),
                        i = e.filter(":first"),
                        s = e.filter(":last");
                    if ((t.target === s[0] || t.target === this.uiDialog[0]) && !t.shiftKey) {
                        this._delay(function () {
                            i.trigger("focus")
                        });
                        t.preventDefault()
                    } else if ((t.target === i[0] || t.target === this.uiDialog[0]) && t.shiftKey) {
                        this._delay(function () {
                            s.trigger("focus")
                        });
                        t.preventDefault()
        ...
        _createTitlebar: function () {
            ...
            this._on(this.uiDialogTitlebar, {
                mousedown: function (t) {
                    if (!I(t.target).closest(".ui-dialog-titlebar-close")) {
        ...
        _createButtons: function () {
            ...
            if (I.isEmptyObject(t) || I.isArray(t) && !t.length) {
            ...
            I.each(t, function (t, e) {
                ...
                delete e.showLabel;
                delete e.icons;
                if (typeof e.text === "boolean") {
                    delete e.text
                }
                I("<button></button>", e).button(s).appendTo(n.uiButtonSet).on("click", function () {
        ...
        _makeDraggable: function () {
            ...
            this.uiDialog.draggable({
                ...
                start: function (t, e) {
                    n._addClass(I(this), "ui-dialog-dragging");
                    n._blockFrames();
                    n._trigger("dragStart", t, o(e))
                },
                drag: function (t, e) {
                ...
                stop: function (t, e) {
                    ...
                    n._removeClass(I(this), "ui-dialog-dragging");
                    n._unblockFrames();
                    n._trigger("dragStop", t, o(e))
                }
            })
        },
        _makeResizable: function () {
            var a = this,
                ...
                i = typeof t === "string" ? t : "n,e,s,w,se,sw,ne,nw";
            ...
            this.uiDialog.resizable({
                ...
                handles: i,
                start: function (t, e) {
                    a._addClass(I(this), "ui-dialog-resizing");
                    a._blockFrames();
                    a._trigger("resizeStart", t, r(e))
                },
                resize: function (t, e) {
                ...
                stop: function (t, e) {
                    ...
                    a._removeClass(I(this), "ui-dialog-resizing");
                    a._unblockFrames();
                    a._trigger("resizeStop", t, r(e))
                }
            }).css("position", e)
        },
        ...
        _setOptions: function (t) {
            ...
            I.each(t, function (t, e) {
                i._setOption(t, e);
                if (t in i.sizeRelatedOptions) {
                    s = true
                }
                if (t in i.resizableRelatedOptions) {
                    n[t] = e
                }
            });
            if (s) {
        ...
        _allowInteraction: function (t) {
            if (I(t.target).closest(".ui-dialog").length) {
                return true
            }
            return !!I(t.target).closest(".ui-datepicker").length
        },
    ...
    var K = I.widget("ui.progressbar", {
        ...
        _constrainedValue: function (t) {
            ...
            this.indeterminate = t === false;
            if (typeof t !== "number") {
                t = 0
            }
            return this.indeterminate ? false : Math.min(this.options.max, Math.max(this.min, t))
        },
        _setOptions: function (t) {
            var e = t.value;
            delete t.value;
        ...
        _refreshValue: function () {
            ...
            if (this.indeterminate) {
                ...
                if (!this.overlayDiv) {
                    this.overlayDiv = I("<div>").appendTo(this.valueDiv);
    ...
    var U = I.widget("ui.selectmenu", [I.ui.formResetMixin, {
        version: "1.12.1",
        ...
        _drawMenu: function () {
            ...
            this.menuWrap = I("<div>").append(this.menu);
            ...
            this.menuInstance = this.menu.menu({
                ...
                focus: function (t, e) {
                    ...
                    if (s.focusIndex != null && i.index !== s.focusIndex) {
                        s._trigger("focus", t, {
                            item: i
                        });
                        if (!s.isOpen) {
        ...
        _move: function (t, e) {
            ...
            if (t === "first" || t === "last") {
                s = i[t === "first" ? "prevAll" : "nextAll"](n).eq(-1)
            } else {
                s = i[t + "All"](n).eq(0)
            }
            if (s.length) {
        ...
        _documentClick: {
            mousedown: function (t) {
                ...
                if (!I(t.target).closest(".ui-selectmenu-menu, #" + I.ui.escapeSelector(this.ids.button)).length) {
                    this.close(t)
                }
            }
        },
        ...
        _getCreateOptions: function () {
            var t = this._super();
            t.disabled = this.element.prop("disabled");
            return t
        },
    ...
    var V = I.widget("ui.slider", I.ui.mouse, {
        version: "1.12.1",
        ...
        _createHandles: function () {
            ...
            for (t = s.length; t < e; t++) {
                a.push(n)
            }
            this.handles = s.add(I(a.join("")).appendTo(this.element));
        ...
        _createRange: function () {
            ...
            if (t.range) {
                if (t.range === true) {
                    ...
                    } else if (I.isArray(t.values)) {
                        t.values = t.values.slice(0)
                    }
                }
                if (!this.range || !this.range.length) {
                    this.range = I("<div>").appendTo(this.element);
        ...
        _mouseCapture: function (t) {
            ...
            this.handles.each(function (t) {
                ...
                if (s > e || s === e && (t === h._lastChangedValue || h.values(t) === u.min)) {
                    s = e;
                    n = I(this);
                    a = t
                }
            ...
            n.trigger("focus");
            r = n.offset();
            l = !I(t.target).parents().addBack().is(".ui-slider-handle");
            this._clickOffset = l ? {
                left: 0,
                top: 0
            } : {
        ...
        _uiHash: function (t, e, i) {
            ...
            if (this._hasMultipleValues()) {
                s.value = e !== undefined ? e : this.values(t);
        ...
        _refreshValue: function () {
            ...
            if (this._hasMultipleValues()) {
                this.handles.each(function (t) {
                    ...
                    h[r.orientation === "horizontal" ? "left" : "bottom"] = i + "%";
                    I(this).stop(1, 1)[l ? "animate" : "css"](h, o.animate);
                ...
                n = this._valueMax();
                i = n !== s ? (t - s) / (n - s) * 100 : 0;
                h[this.orientation === "horizontal" ? "left" : "bottom"] = i + "%";
        ...
        _handleEvents: {
            keydown: function (t) {
                var e, i, s, n, a = I(t.target).data("ui-slider-handle-index");
                switch (t.keyCode) {
                    case I.ui.keyCode.HOME:
                    case I.ui.keyCode.END:
                    case I.ui.keyCode.PAGE_UP:
                    ...
                    case I.ui.keyCode.LEFT:
                        ...
                        if (!this._keySliding) {
                            ...
                            this._addClass(I(t.target), null, "ui-state-active");
                            e = this._start(t, a);
                            if (e === false) {
                                return
                            }
            ...
            keyup: function (t) {
                ...
                if (this._keySliding) {
                    ...
                    this._stop(t, e);
                    this._change(t, e);
                    this._removeClass(I(t.target), null, "ui-state-active")
                }
            }
        }
    });
    ...
    I.widget("ui.spinner", {
        ...
        _getCreateOptions: function () {
            var s = this._super();
            var n = this.element;
            I.each(["min", "max", "step"], function (t, e) {
                var i = n.attr(e);
                if (i != null && i.length) {
                    s[e] = i
                }
        ...
        _events: {
            ...
            "mousedown .ui-spinner-button": function (t) {
                var e;
                e = this.element[0] === I.ui.safeActiveElement(this.document[0]) ? this.previous : this.element.val();
                ...
                this._repeat(null, I(t.currentTarget).hasClass("ui-spinner-up") ? 1 : -1, t)
            },
            "mouseup .ui-spinner-button": "_stop",
            "mouseenter .ui-spinner-button": function (t) {
                if (!I(t.currentTarget).hasClass("ui-state-active")) {
                    return
                }
                if (this._start(t) === false) {
                    return false
        ...
        _start: function (t) {
            if (!this.spinning && this._trigger("start", t) === false) {
                return false
            }
            if (!this.counter) {
                this.counter = 1
        ...
        _increment: function (t) {
            ...
            if (e) {
                return I.isFunction(e) ? e(t) : Math.floor(t * t * t / 5e4 - t * t / 500 + 17 * t / 200 + 1)
            }
            return 1
        },
        _precision: function () {
        ...
        _adjustValue: function (t) {
            ...
            if (s.max !== null && t > s.max) {
                return s.max
            }
            if (s.min !== null && t < s.min) {
                return s.min
            }
            return t
        },
    ...
    if (I.uiBackCompat !== false) {
        I.widget("ui.spinner", I.ui.spinner, {
            _enhance: function () {
    ...
    I.widget("ui.tabs", {
        ...
        _create: function () {
            ...
            if (I.isArray(t.disabled)) {
                t.disabled = I.unique(t.disabled.concat(I.map(this.tabs.filter(".ui-state-disabled"), function (t) {
        ...
        _initialActive: function () {
            ...
            if (!t && i === false && this.anchors.length) {
                i = 0
            }
            return i
        },
        ...
        _panelKeydown: function (t) {
            ...
            if (t.ctrlKey && t.keyCode === I.ui.keyCode.UP) {
                t.preventDefault();
                this.active.trigger("focus")
            }
        },
        _handlePageNav: function (t) {
            if (t.altKey && t.keyCode === I.ui.keyCode.PAGE_UP) {
                this._activate(this._focusNextTab(this.options.active - 1, false));
                return true
            }
            if (t.altKey && t.keyCode === I.ui.keyCode.PAGE_DOWN) {
        ...
        _findNextTab: function (t, e) {
            ...
            while (I.inArray(s(), this.options.disabled) !== -1) {
                t = e ? t + 1 : t - 1
            }
            return t
        },
        ...
        _setOption: function (t, e) {
            ...
            if (t === "collapsible") {
                ...
                if (!e && this.options.active === false) {
                    this._activate(0)
                }
            }
            if (t === "event") {
        ...
        _processTabs: function () {
            ...
            this.anchors.each(function (t, e) {
                var i, s, n, a = I(e).uniqueId().attr("id"),
                    o = I(e).closest("li"),
                ...
                if (l._isLocal(e)) {
                    ...
                    n = o.attr("aria-controls") || I({}).uniqueId()[0].id;
                    i = "#" + n;
                    s = l.element.find(i);
                    if (!s.length) {
                        s = l._createPanel(n);
                        s.insertAfter(l.panels[t - 1] || l.tablist)
                    }
                    s.attr("aria-live", "polite")
                }
                if (s.length) {
                    l.panels = l.panels.add(s)
                }
                if (r) {
                    o.data("ui-tabs-aria-controls", r)
                }
                o.attr({
                    "aria-controls": n,
                    "aria-labelledby": a
        ...
        _createPanel: function (t) {
            return I("<div>").attr("id", t).data("ui-tabs-destroy", true)
        },
        _setOptionDisabled: function (t) {
            var e, i, s;
            if (I.isArray(t)) {
            ...
            for (s = 0; i = this.tabs[s]; s++) {
                e = I(i);
                if (t === true || I.inArray(s, t) !== -1) {
            ...
            this._toggleClass(this.widget(), this.widgetFullName + "-disabled", null, t === true)
        },
        _setupEvents: function (t) {
            var i = {};
            if (t) {
        ...
        _eventHandler: function (t) {
            var e = this.options,
                ...
                a = n[0] === i[0],
                o = a && e.collapsible,
                r = o ? I() : this._getPanelForTab(n),
                l = !i.length ? I() : this._getPanelForTab(i),
                h = {
                    oldTab: i,
                    oldPanel: l,
                    newTab: o ? I() : n,
            ...
            t.preventDefault();
            if (n.hasClass("ui-state-disabled") || n.hasClass("ui-tabs-loading") || this.running || a && !e.collapsible || this._trigger("beforeActivate", t, h) === false) {
                return
            }
            e.active = o ? false : this.tabs.index(n);
            this.active = a ? I() : n;
            if (this.xhr) {
                this.xhr.abort()
            }
        ...
        _toggle: function (t, e) {
            ...
            function o() {
                ...
                if (s.length && i.options.show) {
                    i._show(s, i.options.show, a)
                } else {
                    s.show();
                    a()
                }
        ...
        _findActive: function (t) {
            return t === false ? I() : this.tabs.eq(t)
        },
        _getIndex: function (t) {
            if (typeof t === "string") {
                t = this.anchors.index(this.anchors.filter("[href$='" + I.ui.escapeSelector(t) + "']"))
            }
            return t
        },
        _destroy: function () {
            ...
            this.tabs.add(this.panels).each(function () {
                if (I.data(this, "ui-tabs-destroy")) {
                    ...
                    I(this).removeAttr("role tabIndex " + "aria-live aria-busy aria-selected aria-labelledby aria-hidden aria-expanded")
                }
            });
        ...
        enable: function (i) {
            ...
            if (i === undefined) {
                ...
                if (I.isArray(t)) {
                    ...
                    t = I.map(this.tabs, function (t, e) {
                        return e !== i ? e : null
                    })
                }
            }
        ...
        load: function (t, s) {
            ...
            this.xhr = I.ajax(this._ajaxSettings(e, s, o));
    ...
    I.widget("ui.tooltip", {
        ...
        _addDescribedBy: function (t, e) {
            ...
            i.push(e);
            t.data("ui-tooltip-id", e).attr("aria-describedby", I.trim(i.join(" ")))
        },
        ...
        open: function (t) {
            ...
            if (!e.length || e.data("ui-tooltip-id")) {
                return
            }
            if (e.attr("title")) {
                e.data("ui-tooltip-title", e.attr("title"))
            }
            e.data("ui-tooltip-open", true);
        ...
        _open: function (t, e, i) {
            var s, n, a, o, r = I.extend({}, this.options.position);
            if (!i) {
                return
            }
            s = this._find(e);
            ...
            this.liveRegion.children().hide();
            o = I("<div>").html(n.find(".ui-tooltip-content").html());
        ...
        close: function (t) {
            ...
            if (s.data("ui-tooltip-title") && !s.attr("title")) {
            ...
            if (t && t.type === "mouseleave") {
                I.each(this.parents, function (t, e) {
                    I(e.element).attr("title", e.title);
                    delete i.parents[t]
                })
            }
            n.closing = true;
    ...
    if (I.uiBackCompat !== false) {
        I.widget("ui.tooltip", I.ui.tooltip, {
            options: {
                tooltipClass: null
            },
            _tooltip: function () {
    ...
    (function (u, c) {
        var t = "backgroundColor borderBottomColor borderLeftColor borderRightColor " + "borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
            f = /^([\-+])=\s*(\d+\.?\d*)/,
            e = [{
        ...
        o.rgba = i.style.backgroundColor.indexOf("rgba") > -1;
        m(p, function (t, e) {
            e.cache = "_" + t;
            e.props.alpha = {
                idx: 3,
        ...
        function r(o) {
            ...
            if (l.length) {
                if (l.join() === "0,0,0,0") {
                    u.extend(l, h.transparent)
                }
                return r
            }
            return h[o]
        }
        d.fn = u.extend(d.prototype, {
            parse: function (n, t, e, i) {
                ...
                if (s === "string") {
                    return this.parse(r(n) || h._default)
                }
                if (s === "array") {
                    ...
                    if (n instanceof d) {
                        ...
                        m(p, function (t, i) {
                            ...
                            m(i.props, function (t, e) {
                                ...
                                a[s][e.idx] = _(n[t], e, true)
                            });
                            if (a[s] && u.inArray(null, a[s].slice(0, 3)) < 0) {
                                a[s][3] = 1;
                                if (i.from) {
                                    a._rgba = i.from(a[s])
                                }
            ...
            transition: function (t, o) {
                var r = d(t),
                    e = r._space(),
                    i = p[e],
                    s = this.alpha() === 0 ? d("transparent") : this,
        ...
        p.hsla.to = function (t) {
            ...
            return [Math.round(u) % 360, c, h, n == null ? 1 : n]
        };
        p.hsla.from = function (t) {
            ...
            var e = t[0] / 360,
                ...
                a = s <= .5 ? s * (1 + i) : s + i - s * i,
                o = 2 * s - a;
            return [Math.round(l(o, a, e + 1 / 3) * 255), Math.round(l(o, a, e) * 255), Math.round(l(o, a, e - 1 / 3) * 255), n]
        };
        m(p, function (l, t) {
            var i = t.props,
                o = t.cache,
            ...
            d.fn[l] = function (t) {
                ...
                var e, s = u.type(t),
                    n = s === "array" || s === "object" ? t : arguments,
                    a = this[o].slice();
                m(i, function (t, e) {
                    var i = n[s === "object" ? t : e.idx];
                    if (i == null) {
                        i = a[e.idx]
                    }
                    a[e.idx] = _(i, e)
            ...
            m(i, function (o, r) {
                ...
                d.fn[o] = function (t) {
                    var e = u.type(t),
                        i = o === "alpha" ? this._hsla ? "hsla" : "rgba" : l,
                        s = this[i](),
                        n = s[r.idx],
                        a;
                    if (e === "undefined") {
        ...
        d.hook = function (t) {
            ...
            m(e, function (t, a) {
                u.cssHooks[a] = {
                    set: function (t, e) {
                        var i, s, n = "";
                        if (e !== "transparent" && (u.type(e) !== "string" || (i = r(e)))) {
                            e = d(i || e);
                            if (!o.rgba && e._rgba[3] !== 1) {
                                s = a === "backgroundColor" ? t.parentNode : t;
                                while ((n === "" || n === "transparent") && s && s.style) {
                                    try {
    ...
    (function () {
        ...
        function l(t, e) {
            ...
            for (s in e) {
                ...
                if (t[s] !== n) {
                    if (!a[s]) {
                        if (I.fx.step[s] || !isNaN(parseFloat(n))) {
                            i[s] = n
                        }
                    }
                }
        ...
        I.effects.animateClass = function (n, t, e, i) {
            ...
            return this.queue(function () {
                var i = I(this),
                    t = i.attr("class") || "",
                    e, s = a.children ? i.find("*").addBack() : i;
                s = s.map(function () {
                    var t = I(this);
                    return {
                        el: t,
        ...
        I.fn.extend({
            ...
            toggleClass: function (a) {
                return function (t, e, i, s, n) {
                    if (typeof e === "boolean" || e === undefined) {
                        if (!i) {
                            return a.apply(this, arguments)
                        } else {
                            return I.effects.animateClass.call(this, e ? {
                                add: t
                            } : {
                                remove: t
                            }, i, s, n)
    ...
    (function () {
        if (I.expr && I.expr.filters && I.expr.filters.animated) {
            I.expr.filters.animated = function (e) {
                return function (t) {
                    return !!I(t).data(tt) || e(t)
                }
            }(I.expr.filters.animated)
        }
        if (I.uiBackCompat !== false) {
            I.extend(I.effects, {
                save: function (t, e) {
        ...
        I.extend(I.effects, {
            ...
            define: function (t, e, i) {
                ...
                I.effects.effect[t] = i;
                I.effects.effect[t].mode = e;
                return i
            },
            scaledDimensions: function (t, e, i) {
                ...
                var s = i !== "horizontal" ? (e || 100) / 100 : 1,
            ...
            createPlaceholder: function (t) {
                ...
                if (/^(static|relative)/.test(i)) {
                    i = "absolute";
                    e = I("<" + t[0].nodeName + ">").insertAfter(t).css({
            ...
            cleanUp: function (t) {
                I.effects.restoreStyle(t);
                I.effects.removePlaceholder(t)
            },
        ...
        function u(t, e, i, s) {
            ...
            if (typeof e === "number" || I.fx.speeds[e]) {
                s = i;
                i = e;
                e = {}
            }
            ...
            i = i || e.duration;
            t.duration = I.fx.off ? 0 : typeof i === "number" ? i : i in I.fx.speeds ? I.fx.speeds[i] : I.fx.speeds._default;
            t.complete = s || e.complete;
            return t
        }

        function s(t) {
            if (!t || typeof t === "number" || I.fx.speeds[t]) {
                return true
            }
            if (typeof t === "string" && !I.effects.effect[t]) {
                return true
            }
            if (I.isFunction(t)) {
                return true
        ...
        I.fn.extend({
            effect: function () {
                var n = u.apply(this, arguments),
                    ...
                    i = function (t) {
                        var e = I(this),
                            i = I.effects.mode(e, l) || o;
                        e.data(tt, true);
                        h.push(i);
                        if (o && (i === "show" || i === o && i === "hide")) {
                            e.show()
                        }
                        if (!o || i !== "none") {
                            I.effects.saveStyle(e)
                        }
                        if (I.isFunction(t)) {
                            t()
                        }
                ...
                function s(t) {
                    ...
                    n.mode = h.shift();
                    if (I.uiBackCompat !== false && !o) {
                        if (e.is(":hidden") ? l === "hide" : l === "show") {
                            e[l]();
                            s()
                        } else {
                            a.call(e[0], n, s)
                ...
                return t === false ? this.each(i).each(s) : this.queue(e, i).queue(e, s)
            },
            show: function (i) {
                return function (t) {
                    if (s(t)) {
            ...
            cssClip: function (t) {
                if (t) {
                    return this.css("clip", "rect(" + t.top + "px " + t.right + "px " + t.bottom + "px " + t.left + "px)")
                }
                return e(this.css("clip"), this)
            },
            transfer: function (t, e) {
                var i = I(this),
                    ...
                    u = i.offset(),
                    c = I("<div class='ui-effects-transfer'></div>").appendTo("body").addClass(t.className).css({
                        top: u.top - o,
                        left: u.left - r,
        ...
        function e(t, e) {
            ...
            return {
                ...
                bottom: a[3] === "auto" ? s : parseFloat(a[3]),
                left: parseFloat(a[4]) || 0
            }
        }
        I.fx.step.clip = function (t) {
            if (!t.clipInit) {
                t.start = I(t.elem).cssClip();
                if (typeof t.end === "string") {
                    t.end = e(t.end, t.elem)
                }
                t.clipInit = true
            }
            I(t.elem).cssClip({
    ...
    (function () {
        ...
        I.each(i, function (t, e) {
            ...
            I.easing["easeInOut" + t] = function (t) {
                return t < .5 ? e(t * 2) / 2 : 1 - e(t * -2 + 2) / 2
            }
        })
    })();
    var it = I.effects;
    var st = I.effects.define("blind", "hide", function (t, e) {
        var i = {
                up: ["bottom", "top"],
                vertical: ["bottom", "top"],
                down: ["top", "bottom"],
        ...
        if (t.mode === "show") {
            s.cssClip(o.clip);
            if (r) {
                r.css(I.effects.clipToBox(o))
            }
            o.clip = a
        }
        if (r) {
            r.animate(I.effects.clipToBox(o), t.duration, t.easing)
        }
        s.animate(o, {
            queue: false,
            duration: t.duration,
    ...
    var nt = I.effects.define("bounce", function (t, e) {
        var i, s, n, a = I(this),
            o = t.mode,
            r = o === "hide",
            l = o === "show",
            ...
            d = t.duration / f,
            p = t.easing,
            g = h === "up" || h === "down" ? "top" : "left",
            m = h === "up" || h === "left",
            _ = 0,
            v = a.queue().length;
        I.effects.createPlaceholder(a);
        n = a.css(g);
        if (!u) {
            u = a[g === "top" ? "outerHeight" : "outerWidth"]() / 3
        }
        if (l) {
            s = {
                opacity: 1
            ...
            s[g] = n;
            a.css("opacity", 0).css(g, m ? -u * 2 : u * 2).animate(s, d, p)
        }
        if (r) {
            u = u / Math.pow(2, c - 1)
        }
        ...
        a.queue(e);
        I.effects.unshift(a, v, f + 1)
    });
    var at = I.effects.define("clip", "hide", function (t, e) {
        var i, s = {},
            n = I(this),
    ...
    var ot = I.effects.define("drop", "hide", function (t, e) {
        var i, s = I(this),
            n = t.mode,
            a = n === "show",
            o = t.direction || "left",
        ...
        I.effects.createPlaceholder(s);
        i = t.distance || s[r === "top" ? "outerHeight" : "outerWidth"](true) / 2;
        u[r] = l + i;
        if (a) {
            s.css(u);
            u[r] = h + i;
    ...
    var rt = I.effects.define("explode", "hide", function (t, e) {
    ...
    var lt = I.effects.define("fade", "toggle", function (t, e) {
        var i = t.mode === "show";
    ...
    var ht = I.effects.define("fold", "hide", function (e, t) {
        var i = I(this),
            s = e.mode,
            n = s === "show",
            a = s === "hide",
        ...
        if (n) {
            i.cssClip(p.clip);
            if (c) {
                c.css(I.effects.clipToBox(p))
            }
            p.clip = f
        }
        i.queue(function (t) {
            if (c) {
                c.animate(I.effects.clipToBox(d), u, e.easing).animate(I.effects.clipToBox(p), u, e.easing)
            }
            t()
        }).animate(d, u, e.easing).animate(p, u, e.easing).queue(t);
        I.effects.unshift(i, m, 4)
    });
    var ut = I.effects.define("highlight", "show", function (t, e) {
        var i = I(this),
            s = {
    ...
    var ct = I.effects.define("size", function (n, e) {
        var t, a, i, s = I(this),
            o = ["fontSize"],
        ...
        if (c === "box" || c === "both") {
            if (a.from.y !== a.to.y) {
                m = I.effects.setTransition(s, r, a.from.y, m);
                _ = I.effects.setTransition(s, r, a.to.y, _)
            }
            if (a.from.x !== a.to.x) {
                m = I.effects.setTransition(s, l, a.from.x, m);
                _ = I.effects.setTransition(s, l, a.to.x, _)
            }
        }
        if (c === "content" || c === "both") {
            if (a.from.y !== a.to.y) {
                m = I.effects.setTransition(s, o, a.from.y, m);
                _ = I.effects.setTransition(s, o, a.to.y, _)
            }
        }
        if (f) {
            t = I.effects.getBaseline(f, g);
            m.top = (g.outerHeight - m.outerHeight) * t.y + p.top;
            m.left = (g.outerWidth - m.outerWidth) * t.x + p.left;
            _.top = (g.outerHeight - _.outerHeight) * t.y + p.top;
            _.left = (g.outerWidth - _.outerWidth) * t.x + p.left
        }
        s.css(m);
        if (c === "content" || c === "both") {
            ...
            s.find("*[width]").each(function () {
                ...
                if (a.from.y !== a.to.y) {
                    i = I.effects.setTransition(t, r, a.from.y, i);
                    s = I.effects.setTransition(t, r, a.to.y, s)
                }
                if (a.from.x !== a.to.x) {
                    i = I.effects.setTransition(t, l, a.from.x, i);
                    s = I.effects.setTransition(t, l, a.to.x, s)
                }
                if (u) {
                    I.effects.saveStyle(t)
                }
                t.css(i);
        ...
        s.animate(_, {
            ...
            complete: function () {
                var t = s.offset();
                if (_.opacity === 0) {
                    s.css("opacity", m.opacity)
                }
                if (!u) {
                    s.css("position", d === "static" ? "relative" : d).offset(t);
                    I.effects.saveStyle(s)
                }
                e()
            }
        })
    });
    var ft = I.effects.define("scale", function (t, e) {
        var i = I(this),
            s = t.mode,
            n = parseInt(t.percent, 10) || (parseInt(t.percent, 10) === 0 ? 0 : s !== "effect" ? 0 : 100),
            a = I.extend(true, {
        ...
        I.effects.effect.size.call(this, a, e)
    });
    var dt = I.effects.define("puff", "hide", function (t, e) {
        var i = I.extend(true, {}, t, {
            fade: true,
            percent: parseInt(t.percent, 10) || 150
        });
        I.effects.effect.scale.call(this, i, e)
    });
    var pt = I.effects.define("pulsate", "show", function (t, e) {
        var i = I(this),
            s = t.mode,
            n = s === "show",
            a = s === "hide",
        ...
        i.queue(e);
        I.effects.unshift(i, c, r + 1)
    });
    var gt = I.effects.define("shake", function (t, e) {
        var i = 1,
            s = I(this),
            n = t.direction || "left",
            a = t.distance || 20,
        ...
        for (; i < o; i++) {
            s.animate(f, l, t.easing).animate(d, l, t.easing)
        }
        s.animate(f, l, t.easing).animate(c, l / 2, t.easing).queue(e);
        I.effects.unshift(s, p, r + 1)
    });
    var mt = I.effects.define("slide", "show", function (t, e) {
        var i, s, n = I(this),
            a = {
                up: ["bottom", "top"],
                down: ["top", "bottom"],
            ...
            h = r === "up" || r === "left",
            u = t.distance || n[l === "top" ? "outerHeight" : "outerWidth"](true),
            c = {};
        I.effects.createPlaceholder(n);
        i = n.cssClip();
        s = n.position()[l];
    ...
    var it;
    if (I.uiBackCompat !== false) {
        it = I.effects.define("transfer", function (t, e) {
            I(this).transfer(t, e)
        })
    }
    var _t = it
