...
<hr>
<h1> 코드 까 보면 얘 밑에 div 지우면 모달창 안뜨고 안지우면 모달창 뜸 </h1>
<h1> 연결 방법 몰라서.. 일단 이 페이지 살려두고, </h1>
<h1> 고객의 소리1.html 파일이랑 고객의소리2.html 파일만들어뒀음</h1>
<h1> 저 둘이 그 각각의 html 파일임 ..! </h1>
<div id="layerPrivacyAgree" class="layer-pop" tabindex="0" style="display: block;">
...
<p>귀하께서는 한섬의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 고객의 소리 관리 담당자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것 입니다.</p></pre>
                ...
                <form id="moveVocPage" name="moveVocPage" method="post">
	                <ul class="input-info-group">
						<li>
							...
							<p class="txt-invalid">오류 메시지 출력</p>
						</li>
						<li>
							<div class="input-box">
        ...
        <button type="button" class="btn-layer-close" onclick="layer.close('layerPrivacyAgree');$('#layerPrivacyAgree').remove();">닫기</button>
    </div>
</div>
